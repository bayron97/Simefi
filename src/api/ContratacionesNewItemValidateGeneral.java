...
import main.dao.contratacionesDetalleGeneralDao;
...
import main.model.contratacionesDetalleGeneral;
import main.model.vaciadoOfertasALP;

/**
 * Servlet implementation class controlSuministros
 */
@WebServlet("/ContratacionesNewItemValidateGeneral")
public class ContratacionesNewItemValidateGeneral extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ContratacionesNewItemValidateGeneral() {
		super();
		...
		contratacionesDetalleGeneral b = new contratacionesDetalleGeneral();
			...
			if (NoItem != null) {			
					...
					if(Integer.parseInt(CantidadEntregadaUnidades)  > 0) {						
						...
						contratacionesDetalleGeneralDao.updateRecepcion(b);				
						...
						if(Integer.parseInt(CantidadEntregadaUnidades) != Integer.parseInt(CantidadEntregadaPlazos)) {
							...
							var ccs = contratacionesDetalleGeneralDao.saveall(b);	
