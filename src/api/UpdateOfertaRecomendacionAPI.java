 ...
 */
@WebServlet("/UpdateOfertaRecomendacionAPI")
public class UpdateOfertaRecomendacionAPI extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateOfertaRecomendacionAPI() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String resultado = "";
			...
			if (noOferta != null) {	
				...
				vaciadoOfertasALPDao.productoConRecomendacion(vaciadoOfertasALPDao.obtenerProcesoCompra(Integer.parseInt(noOferta)));
