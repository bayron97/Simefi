 ...
 */
@WebServlet("/ObtenerCriteriosEvaluacionOpcionesProCompraAPI")
public class ObtenerCriteriosEvaluacionOpcionesProCompraAPI extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ObtenerCriteriosEvaluacionOpcionesProCompraAPI() {
		super();
