 ...
 */
@WebServlet("/PantallasExportAPI")
public class PantallasExportAPI extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PantallasExportAPI() {
		super();
		...
		if (step != null && !step.isEmpty()) {
			...
			switch (step) {
				case "RactificacionExport":
					...
					data = contratacionesDao.getRactificacionListExport(codSolicitudCompraParam,procesoCompraParam);
