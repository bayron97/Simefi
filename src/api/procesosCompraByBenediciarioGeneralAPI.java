 ...
 */
@WebServlet("/procesosCompraByBenediciarioGeneralAPI")
public class procesosCompraByBenediciarioGeneralAPI extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public procesosCompraByBenediciarioGeneralAPI() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (step != null && !step.isEmpty()) {
			...
			switch (step) {
				case "0":
					String procesosList = procesoCompraGeneralDao.getProcesosCompraGeneral(beneficiario);
				...
				default:
					...
					String procesosListBycod = procesoCompraGeneralDao.getProcesosCompraGeneral(beneficiario);
