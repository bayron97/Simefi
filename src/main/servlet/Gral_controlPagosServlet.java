 ...
 */
@WebServlet("/Gral_controlPagosServlet")
public class Gral_controlPagosServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Gral_controlPagosServlet() {
		super();
...
//		String sessionType = (String) session.getAttribute("type");
		...
		request.getRequestDispatcher("Gral_controlPagos.jsp").forward(request, response);
	}
