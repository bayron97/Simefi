 ...
 */
@WebServlet("/evaluacionRecomendacionALPInit")
public class evaluacionRecomendacionALPInit extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public evaluacionRecomendacionALPInit() {
		super();
			...
			switch (func) {
				...
				case "consultar":
					...
					if (codPadre == null || codPadre.isEmpty()) {
						...
						System.out.println(idPadre + " padre");
