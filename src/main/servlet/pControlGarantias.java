 ...
 */
@WebServlet("/pControlGarantias")
public class pControlGarantias extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public pControlGarantias() {
		super();
		...
		switch (submit) {
			...
			case "modificar":
				...
				if (id != null && !id.isEmpty()) {
					...
					controlGarantias p = controlGarantiasDao.getById(Integer.parseInt(id));
					...
					request.setAttribute("moneda", p.getmoneda());
					request.setAttribute("ValorOrdenCompra", p.getValorOrdenCompra());
