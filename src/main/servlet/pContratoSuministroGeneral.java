 ...
 */
@WebServlet("/pContratoSuministroGeneral")
public class pContratoSuministroGeneral extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public pContratoSuministroGeneral() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		switch (submit) {
			case "nuevo":
				cod = -1;
				next = "nContratoSuministroGeneral.jsp";
			...
			case "modificar":
				...
				if (id != null && !id.isEmpty()) {
					...
					contratoSuministroGeneral p = contratoSuministroGeneralDao.getById(Integer.parseInt(id));
