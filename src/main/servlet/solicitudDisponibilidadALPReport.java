 ...
 */
@WebServlet("/solicitudDisponibilidadALPReport")
public class solicitudDisponibilidadALPReport extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public solicitudDisponibilidadALPReport() {
		super();
...
//				request.setAttribute("fechaAperturaProcesoCompra", fechaAperturaProcesoCompra);
				...
				request.getRequestDispatcher("reporteSolicitudDisponibilidadALP.jsp").forward(request, response);
			}
			else {
