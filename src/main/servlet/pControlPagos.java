 ...
 */
@WebServlet("/pControlPagos")
public class pControlPagos extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public pControlPagos() {
		super();
		...
		switch (submit) {
			...
			case "modificar":
				...
				if (id != null && !id.isEmpty()) {
					...
					controlPagos p = controlPagosDao.getById(Integer.parseInt(id));
