 ...
 */
@WebServlet("/pContrataciones")
public class pContrataciones extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public pContrataciones() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		switch (submit) {
			case "nuevo":
				cod = -1;
				next = "nOrdenDeCompra.jsp";
				session.setAttribute("Id", cod);
...
//				}
				...
				String codigo= "OC0000-0";
				
				
				request.setAttribute("ordencompra",codigo);
			...
			case "modificar":
				...
				if (id != null && !id.isEmpty()) {
					...
					contrataciones p = contratacionesDao.getById(Integer.parseInt(id));
