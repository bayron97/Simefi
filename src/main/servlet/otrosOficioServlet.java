 ...
 */
@WebServlet("/otrosOficioServlet")
@MultipartConfig
public class otrosOficioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public otrosOficioServlet() {
		super();
                	...
                	for(int j=0; j<idArchivo.length; j++) {
                		if(idArchivo[j].contentEquals(String.valueOf(i))){
							...
							if (filePart != null && filePart.getSize() > 0) {
								...
								String contextPath = getServletContext().getRealPath("/assets/files/otherFiles/"+ fileName);
								...
								otroOficio o = new otroOficio();
								o.setIdotro(Integer.parseInt(Id));
								o.setOficio(noOficio[j]);
								o.setNombreDocumento(fileName);
								otroOficioDao.save(o);
							}
                		}
