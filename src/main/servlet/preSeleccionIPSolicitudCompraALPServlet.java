 ...
 */
@WebServlet("/preSeleccionIPSolicitudCompraALPServlet")
public class preSeleccionIPSolicitudCompraALPServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public preSeleccionIPSolicitudCompraALPServlet() {
		super();
...
//						}
						...
						String nomProductoFilter[] = request.getParameterValues("nomProductoFilter");
						if (nomProductoFilter != null)
						{
							for (int a=0; a<nomProductoFilter.length; a++)
							{
								productos = productos+"-"+nomProductoFilter[a];
							}
						}
						...
						request.setAttribute("noSolDisponibilidad", "");
				...
				case "CONSULTAR":
					...
					String retorno = request.getParameter("submitButton");
					
					if(retorno.contentEquals("indexR")) {
