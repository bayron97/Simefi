...
import main.servlet.insertU;

public class ofertaALP {
	private String procesoCompra, fechaOferta, distribuidor, medicamentoEstimado, up, precio, moneda, codATC,
			...
			recomendacionesBeneficiario, nombreFabricante, registroSanitario, fechaVencSan, fechaEmisionSan, certificadoManufactura,
			...
			unidadPresentacionRequerida, paisOrigen, noOferta, codSesal, obsOfertaCEO, precioTotal;
	private int codPadre, noOfertasRecibidas, canEstimadaOferta,prelacionRALP,noOfertaIngresada;
	...
	public int getcanEstimadaOferta() {
		return canEstimadaOferta;
	}

	public void setcanEstimadaOferta(int canEstimadaOferta) {
		this.canEstimadaOferta = canEstimadaOferta;
	}
	...
	public String getnoOferta() {
		return noOferta;
	}

	public void setnoOferta(String	 noOferta) {
		this.noOferta = noOferta;
	}	
	
	public int getnoOfertaIngresada() {
		return noOfertaIngresada;
	}

	public void setnoOfertaIngresada(int noOfertaIngresada) {
		this.noOfertaIngresada = noOfertaIngresada;
	}
	...
	public String getobsOfertaCEO() {
		return obsOfertaCEO;
	}

	public void setobsOfertaCEO(String	obsOfertaCEO) {
		this.obsOfertaCEO = obsOfertaCEO;
	}	
