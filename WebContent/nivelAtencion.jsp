...
<body class="sidemenu-open header-fixed-top body-general-styles">
					...
					<div class="container-fluid" id="submenu-container">
						<div class="row">
							...
							<form method="post" action="ParametrizacionRouting">
								...
								<input class="hide" type="submit" id="administrationRoute"
									name="submit" value="parametrizacion.jsp" />
								<input class="hide" type="submit" id="presentationUnit"
									name="submit" value="up.jsp" />
								<input class="hide" type="submit" id="categories" name="submit"
									value="categorias.jsp" />
								...
								<div class="dropdown mr-auto d-flex d-sm-none">
									...
									<div class="dropdown-menu">
										<label class="dropdown-item" for="administrationRoute">VIA
											DE ADMINISTRACION</label> <a class="dropdown-item active" href="#">NIVEL
											DE ATENCION</a> <label class="dropdown-item"
											for="presentationUnit">UNIDAD DE PRESENTACION (UP)</label> <label
											class="dropdown-item" for="categories">CATEGORIAS</label>
									</div>
								</div>
								<ul class="nav nav-pills mr-auto d-none d-sm-flex">
									<li class="nav-item"><label class="nav-link"
										for="administrationRoute">VIA DE ADMINISTRACION</label></li>
									<li class="nav-item"><a class="nav-link active" href="#">NIVEL
											DE ATENCION</a></li>
									<li class="nav-item"><label class="nav-link"
										for="presentationUnit">UNIDAD DE PRESENTACION (UP)</label></li>
									<li class="nav-item"><label class="nav-link"
										for="categories">CATEGORIAS</label></li>
								</ul>
							</form>
							</nav>
						...
						<div class="container main-container">
							<div class="row align-items-center">
								<div class="col-12 col-xs-12 col-md-12">
									<h2 class="mb-4 large-title">PARAMETRIZACION DE
										MEDICAMENTOS & OTROS INSUMOS</h2>
									<h5 class="font-weight-light main-font">NIVEL DE ATENCION
									</h5>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-auto align-self-center main-font">
								...
								<button class="btn btn-sm btn-success ml-2"
									data-target="#newEditReg" data-toggle="modal" id="newRegButton">
									<i class="material-icons md-18">add_circle</i> NUEVO
								</button>
								<button class="btn btn-sm btn-success ml-2"
									data-target="#newEditReg" data-toggle="modal"
									id="editRegButton">
								...
								<button class="btn btn-sm btn-success ml-2"
									...
									<i class="material-icons md-18">spellcheck</i> ACTIVAR /
									INACTIVAR
								</button>
						...
						<table id="datatable"
							...
							<thead>
								<tr>
									...
									<th class="min-tablet">NIVEL DE ATENCION</th>
									<th class="min-tablet">ESTABLECIMIENTO</th>
							...
							<tbody>
								...
								try {
									...
									String QueryString = "SELECT * from dbo.nivelAtencion where nivel = '1ER NIVEL DE ATENCION' order by id ASC";
								...
								<tr>
									<td><%=i%></td>
									<td hidden><%=rs.getString(6)%></td>
									<td><%=rs.getString(1).toUpperCase()%></td>
									<td><%=st.toUpperCase()%></td>
									<td><%=abrv.toUpperCase()%></td>
									<%
									if (st2 == null || st2.isEmpty() || st2.toUpperCase().contentEquals("INACTIVO")) {
									%>
									<td>
								...
								QueryString = "SELECT * from dbo.nivelAtencion where nivel = '2DO NIVEL DE ATENCION' order by id ASC";
								rs = state.executeQuery(QueryString);
								while (rs.next()) {
								String st = rs.getString(2);
								if (rs.wasNull()) {
	...
	<form method="post" action="ParametrizacionRouting">
		...
		<div class="wrap-fixed-float wrap-fixed-bottom-left">
			<button class="btn btn-primary btn-rounded-circle shadow"
				name="submit" value="parametrizacion.jsp">
		...
		<div class="wrap-fixed-float wrap-fixed-bottom-right">
			<button class="btn btn-primary btn-rounded-circle shadow"
				type="submit" name="submit" value="up.jsp">
	...
	<!--New Edit Reg Modal-->
	<div class="modal fade main-font" id="newEditReg" tabindex="-1"
		role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered"
			role="document">
			<!--Form Edit Reg starts-->
			<form id="editRegForm" method="post" action="nivelAtencionServlet">
				<div class="modal-content shadow-lg-dark overflow-hidden">
					...
					<div class="modal-body" style="background-color: #f1f1f1;">
						...
						<div class="text-center pb-5">
							<h1 class="mb-0 text-white">PARAMETRIZACION DE NIVEL DE
								ATENCION</h1>
											...
											<div class="card-body">
												<div class="row justify-content-center">
													<div class="col-md-10 mx-auto">
														<!--DATA Section-->
														<div id="dataSection">
															<input type="hidden" id="modifId" value="0"
																name="modifId">
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>NIVEL DE ATENCION*</label>
																			<!-- <input type="hidden" id="overlayNivel2" name="overlayNivel2"/> -->
																			<select class="form-control" id="overlayNivel"
																				name="overlayNivel" required>
																				<option value="1ER NIVEL DE ATENCION" selected>1ER
																					NIVEL DE ATENCION</option>
																				<option value="2DO NIVEL DE ATENCION">2DO
																					NIVEL DE ATENCION</option>
																			</select>
																		</div>
																	</div>
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>ESTABLECIMIENTO*</label> <input
																				autocomplete="off" type="text" class="form-control"
																				id="overlayNombre" name="overlayNombre"
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>ABREVIACION DE ESTABLECIMIENTO*</label> <input
																				autocomplete="off" type="text" class="form-control"
																				id="overlayAbrv" name="overlayAbrv" placeholder=""
																				required />
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>OBSERVACION</label> <input autocomplete="off"
																				type="text" class="form-control" id="overlayObs"
																				name="overlayObs" placeholder="" />
																		</div>
																	</div>
																</div>
														</div>
														...
														<div id="stateSection"
															...
															<div class="row">
																...
																<div class="col-lg-6 col-md-6">
																	<div class="form-group">
																		<input type="checkbox" id="checkInactivo" name="in2" />
							...
							<div class="row w-100 mx-0">
								...
								<div class="col-12 col-md-6 text-center">
									<button id="ButtonModal" type="button"
										class="mb-2 shadow-sm mr-2 btn btn-lg btn-success">
										GUARDAR</button>
									<input class="hide" type="submit" id="submitButton"
	...
	<script>
		...
		$("#datatable tr").click(
				function() {
					...
					$("#overlayNivel").prop("value", value);
					/*  $("#overlayNivel2").prop("value", value); */
				...
				.on(
						...
						function() {
							...
							$("#editRegForm #dataSection div div div select")
									.prop("disabled", false);
							$("#editRegForm #stateSection div div div input")
									.prop("disabled", true);
							$("#editRegForm")[0].reset();
				...
				.on(
						...
						function(event) {
							...
							var url = getAbsolutePath()
									+ "ValidarParamNivelDeAtencionAPI";
							var overlayNivel = document
									.getElementById("overlayNivel").value;
							var overlayNombre = document
									.getElementById("overlayNombre").value;
									...
									.ajax({
										...
										success : function(data) {
											...
											if (parseInt(data) == 0) {
												...
												$("#confirMessage")
														.text(
																"ALERTA! NIVEL DE ATENCIÓN Y ESTABLECIMIENTO YA ESTAN REGISTRADOS INGRESE UNA NUEVA");
