...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
  ...
  <body class="header-fixed-top body-general-styles">
              ...
              <form action ="pcGeneralRouting" method="post">
                ...
                <input class="hide" type="submit" name="nextJsp" value ="requerimientos" id="req"/>
                  ...
                  <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="#">TERMINOS DE REFERENCIA</a>
                    </li>
                  </ul>
                </nav>
                </form>
        ...
        <div class="container main-container main-font" id="main-container">
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            ...
            <%
              ...
              String Modal="",noProcesoCompra="",observaciones="";
              if(estado.contentEquals("EN PROCESO") || estado.contentEquals("CORREGIR")){
              ...
              try{ 
                ...
                String QueryString = "select noProcesoCompra,observaciones from procesoCompraGeneral WHERE idProcesoCompraGeneral="+id;
                rs = state.executeQuery(QueryString);
                while(rs.next()){
                   noProcesoCompra = rs.getString(1);
                   observaciones = rs.getString(2);
                }
              } catch(Exception e){ System.out.println(e); }
            
            %>
            <form id="digForm" method="post" action="digitizedDocumentGeneralServlet" enctype="multipart/form-data">
                          ...
                          <div class="card-body">
                            <div class="row justify-content-center">
                              <div class="col-md-10 mx-auto">
                                <!--DATA Section-->
                                <div id="dataSection">
                                <% if (func.toUpperCase().contentEquals("NUEVO") || func.toUpperCase().contentEquals("MODIFICAR")) {%>
                                  <div class="row">
                                      ...
                                      <div class="form-group">
                                        ...
                                        >
                                          ...
                                          <tbody>
                                                  ...
                                                  String QueryString = "select * from dbo.digitizedDocumentsForGeneral where buyProcessID = " + buyCod;
                                                  rs = state.executeQuery(QueryString); %> 
                                                  <% while(rs.next()){ %>
                                                	<tr>
                                                    <td>-1</td>
                                                    ...
                                                    <td>
                                                    <button class="btn btn-sm btn-success previewButton" title="MOSTRAR" onclick="event.preventDefault();" value="assets/files/buyProcessGeneralFiles/digitizedDocument/<%=rs.getString(3)%>">
                                                      <i class="material-icons">receipt</i>
                                                    </button>
                                                    <a class="btn btn-sm btn-success" target="_blank" title="EXPORTAR" href="assets/files/buyProcessGeneralFiles/digitizedDocument/<%=rs.getString(3)%>">
    ...
    <!-- Cancel Float Button -->
    <form method="post" action="nPurchaseListRequirementGeneral.jsp">
