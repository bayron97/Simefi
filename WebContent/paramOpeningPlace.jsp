  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
                  ...
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item active" href="#">LUGAR DE APERTURA</a>
                    ...
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      <li class="nav-item">
                        <a class="nav-link active" href="#">LUGAR DE APERTURA</a>
                      </li>
                      <li class="nav-item">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">LUGAR DE APERTURA</th>
                ...
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.lugarApertura";
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="lugarAperturaServlet">
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#lugarApert").prop("value", value);
        value = $(this).find("td:eq(4)").text();
        $("#obsApert").prop("value", value);
