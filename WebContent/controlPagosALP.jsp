  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
      ...
      <div class="content shadow-sm main-content-div">
		...
		%>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	<form method="post" action="pControlPagos">
          	<input type="hidden" id="id" name="id"/>
          	<input type="hidden" id="type" name="type" value="ALP"/>
         	<input type="hidden" id="type" name="next" value="controlPagosALP.jsp"/>
                ...
                <%if (acceso.contentEquals("administrar") || acceso.contentEquals("digitar")) { %>
                 ...
                 <%} %>
                  ...
                  <button
                    ...
                    data-toggle="modal"
                    data-target="#UpdateControlPagos"
                  >
                    <i class="material-icons md-18">format_shapes</i>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-desktop">NO. ORDEN DE COMPRA</th>
                    <th class="min-desktop">DISTRIBUIDOR/FABRICANTE</th>
                    <th class="all">MONTO TOTAL A PAGAR</th>
                    <th class="min-desktop">ESTADO</th>
                    <th class="min-desktop">FECHA</th>
                    <th class="all">NO. DE REFERENCIA</th>
                  </tr>
                </thead>
                <tbody>
                <%
			        try{
				        ...
				        String QueryString = "SELECT Id,fecha,buyProcessCod, buyOrderId, proveedor,pagoTotal, estado,noReferencia FROM ControlPagos";
			      ...
			      %>
						        <tr>
							        ...
							        <td><%=rs.getString(5).toUpperCase()%></td>
			                      	...
			                      	<td><%=fecha%></td>
			                      	<td><%=noReferencia.toUpperCase()%></td>
						        </tr>
			      <%}
			        rs.close();
			        state.close();
    ...
    >
      <div class="modal-dialog modal-l modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="controlPagosServlet">
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#buttonGuardar").removeClass("hide");
        var value;
        value = $(this).find("td:eq(0)").text();
        $("#id").prop("value",value);
        $("#Id").prop("value",value);
        $("#procesocompra").prop("value",$(this).find("td:eq(1)").text());
        $("#ordencompra").prop("value",$(this).find("td:eq(2)").text());
        $("#fecha").prop("value",$(this).find("td:eq(6)").text());
        $("#noReferencia").prop("value",$(this).find("td:eq(7)").text());
      });
    </script>
