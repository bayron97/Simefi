    ...
    <div class="wrapper">
      <div class="content shadow-sm main-content-div">
        ...
        <div class="container main-container main-font" id="main-container">
                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    ...
                    <h5 class="font-weight-light">
                      CORRELATIVO PARA PROCESOS DE COMPRA
                    </h5>
                  </div>
                </div>
              </div>
          ...
          <%if (auth == true) {%>
          <form action="numeroProcesoCompraServlet" method="post">
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6">
                        <div class="form-group" style="text-align: left">
                          <label>MECANISMOS DE COMPRA ACTIVOS</label>
                          <select
                            autocomplete="off"
                            class="form-control"
                            id="purchaseType"
                          ...
                          >
                            ...
                            <% try{ 
                                ...
                                String QueryString = "select abreviatura, tipoCompra from tipoCompra where estado='ACTIVO'";
                                rs = state.executeQuery(QueryString);
                                while(rs.next()){%>
                                  <option value="<%=rs.getString(1)%>">
                                    <%=rs.getString(1).toUpperCase() + " - " + rs.getString(2).toUpperCase()%>
                                  </option>
            ...
            >
              ...
              <tbody>
                <% try{ 
                  ...
                  con = DriverManager.getConnection(url,"admin","system123");
                  state = con.createStatement(); 
                  String QueryString = "SELECT * from dbo.numeroProcesoCompra order by idincremental";
                  rs = state.executeQuery(QueryString); 
                %> <% while(rs.next()){ 
                        ...
                        if(rs.wasNull()){ 
                          ...
                          <tr>
                            <td hidden><%=rs.getInt(4)%></td>
                            <td><%=cod.toUpperCase()%></td>
