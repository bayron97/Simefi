...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  ...
                  <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                    ...
                    <li class="nav-item">
                      <label class="nav-link">RATIFICACION</label>
                    </li>
                  </ul>
                </nav>
    ...
    <form class="main-font" action="vaciadoEvaluacionRatificacionALPStepRouting" method="post">
      ...
      <div id="emptyingOffersButton" class="wrap-fixed-float wrap-fixed-bottom-right">
        <button
          class="btn btn-primary btn-rounded shadow main-font"
          type="submit"
          name="submit"
          value="ratificarOferta"
        >
          <span>RATIFICAR OFERTAS </span>
