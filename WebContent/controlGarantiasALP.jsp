      ...
      <div class="content shadow-sm main-content-div">
		...
		%>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	<form method="post" action="pControlGarantias">
          	<input type="hidden" id="id" name="id"/>
          	<input type="hidden" id="type" name="type" value="ALP"/>
         	<input type="hidden" id="type" name="next" value="controlGarantias.jsp"/>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-desktop">NO. DE ORDEN</th>
                    <th class="min-desktop">VALOR DE GARANTIA</th>
                    <th class="min-desktop">NO. GARANTIA</th>
                    <th class="min-desktop">FECHA EMISION</th>
                    <th class="min-desktop">FECHA DE CADUCIDAD</th>
                    <th class="min-desktop">TIPO DE GARANTIA</th>
                ...
                <%
			        try{
				        ...
				        String QueryString = "select Id, buyProcessCod, beneficiario, proveedor, buyOrderId, valorGarantia, warrantyNo, fechaemision, fechacaducidad, warrantytype, estado from ControlGarantias";
