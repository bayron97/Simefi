...
<body class="sidemenu-open header-fixed-top body-general-styles">
					...
					<div class="container-fluid" id="submenu-container">
						<div class="row">
							...
							<form method="post" action="ParametrizacionRouting">
								<input class="hide" type="submit" id="parametrizacion"
									name="submit" value="parametrizacion.jsp" />
								<input class="hide" type="submit" id="nivelatencion"
									name="submit" value="nivelAtencion.jsp" />
								<input class="hide" type="submit" id="categorias" name="submit"
								...
								<div class="dropdown mr-auto d-flex d-sm-none">
									...
									<div class="dropdown-menu">
										<label class="dropdown-item" for="parametrizacion">VIA
											DE ADMINISTRACION</label> <label class="dropdown-item"
											for="nivelatencion">NIVEL DE ATENCION</label> <a
											class="dropdown-item active" href="#">UNIDAD DE
											PRESENTACION (UP)</a> <label class="dropdown-item"
											for="categorias">CATEGORIAS</label>
									</div>
								</div>
								<ul class="nav nav-pills mr-auto d-none d-sm-flex">
									<li class="nav-item"><label class="nav-link"
										for="parametrizacion">VIA DE ADMINISTRACION</label></li>
									<li class="nav-item"><label class="nav-link"
										for="nivelatencion">NIVEL DE ATENCION</label></li>
									<li class="nav-item"><a class="nav-link active" href="#">UNIDAD
											DE PRESENTACION (UP)</a></li>
									<li class="nav-item"><label class="nav-link"
										for="categorias">CATEGORIAS</label></li>
								</ul>
							</form>
							</nav>
						...
						<div class="container main-container">
							<div class="row align-items-center">
								<div class="col-12 col-xs-12 col-md-12">
									...
									<h5 class="font-weight-light main-font">UNIDADES DE
										PRESENTACION</h5>
								</div>
							</div>
						</div>
						...
						<table id="datatable"
							...
							<tbody>
								...
								try {
									...
									String QueryString = "SELECT * from dbo.up order by id ASC";
								...
								<tr>
									...
									<%
									if (st2 == null || st2.isEmpty() || st2.contentEquals("INACTIVO")) {
									%>
									<td>
	...
	<form method="post" action="ParametrizacionRouting">
		...
		<div class="wrap-fixed-float wrap-fixed-bottom-right">
			<button class="btn btn-primary btn-rounded-circle shadow"
				name="submit" value="categorias.jsp">
	...
	<div class="modal fade main-font" id="newEditReg" tabindex="-1"
		...
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<form id="editRegForm" method="post" action="upServlet">
				<div class="modal-content shadow-lg-dark overflow-hidden">
					...
					<div class="modal-body" style="background-color: #f1f1f1;">
						...
						<div class="text-center pb-5">
							<h1 class="mb-0 text-white">PARAMETRIZACION DE UNIDAD DE
								PRESENTACION (UP)</h1>
														...
														<div id="dataSection">
															<input type="hidden" id="modifId" value="0"
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>UNIDAD PRESENTACION*</label> <input
																				autocomplete="off" type="text" class="form-control"
																				id="overlayUnd" name="overlayUnd" placeholder=""
																				required />
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>ABREVIACION*</label> <input autocomplete="off"
																				type="text" class="form-control" id="overlayAbrv"
																				name="overlayAbrv" placeholder="" required />
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>OBSERVACIONES</label> <input
																				autocomplete="off" type="text" class="form-control"
																				id="overlayObs" name="overlayObs" placeholder="" />
																		</div>
																	</div>
																</div>
														</div>
				...
				.on(
						...
						function() {
							...
							$("#editRegForm #dataSection div div div input")
									.prop("readonly", false);
							document.getElementById("submitButton").value = "nuevo";
							$("#editRegForm")[0].reset();
				...
				.on(
						...
						function() {
							...
							if (value === "") {
								...
								document.getElementById("submitButton").value = "modif";
								$("#subtitleChange").text("EDITAR REGISTRO");
								$("#infoIcon").text("format_shapes");
								$("#instructionSubtitle")
										.text(
				...
				.on(
						...
						function() {
							...
							if (value === "") {
								...
								$("#editRegForm #dataSection").removeClass(
										"hide");
								$("#editRegForm #stateSection").removeClass(
										"hide");
								$("#editRegForm #submitButtonsSection")
										.removeClass("hide");
							}
				...
				.on(
						...
						function(event) {
							...
							var url = getAbsolutePath()
									+ "ValidarParamUnidadDePresentacionAPI";
							var overlayUnd = document
									.getElementById("overlayUnd").value;
							var overlayAbrv = document
									.getElementById("overlayAbrv").value;
							...
							$
									.ajax({
										...
										dataType : 'json',
										data : {
											overlayUnd : overlayUnd,
											overlayAbrv : overlayAbrv,
											modifId : modifId
										},
										success : function(data) {
											...
											if (parseInt(data) == 0) {
												...
												$("#confirMessage")
														.text(
																"ALERTA! ESTA UNIDAD DE PRESENTACIÓN Y ABREVIATURA YA ESTA REGISTRADA INGRESE UNA NUEVA");
