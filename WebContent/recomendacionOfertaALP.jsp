                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-12">
                    <h2 class="mb-4 large-title">
                      INFORMES DE RECOMENDACION POR PROCESO DE COMPRA
                    </h2>
              ...
              <div class="row">
                ...
                <%if (acceso.contentEquals("administrar") || acceso.contentEquals("digitar")) { %>
                  <button
                    ...
                    id="newRecomendaciones"
                    name="submit"
                    value="nuevaRecomendacionTecnica"
                  >
                    <i class="material-icons md-18">edit</i> INGRESAR RECOMENDACIONES TECNICAS
                  </button>
                   <%} %>
                  ...
                  >
                    ...
                    id="consulButton"
                    name="submit"
                    value="verCatalogoRecomendadoV2"
                  >
                    <i class="material-icons md-18">chrome_reader_mode</i>
                    VER CATALOGO V2
                  </button>
                  ...
                  <button
                    ...
                    id="consulButton"
                    name="submit"
                    value="consultarRecomendacionTecnica"
                  >
                    <i class="material-icons md-18">chrome_reader_mode</i>
                    CONSULTAR
                  </button>
		...
		<%if (auth == true) {%>
            <div class="card-body main-font" >
              ...
              <table
                ...
                aria-describedby="Tabla de productos ofertados"
              >
                <thead>
                  <tr>
                    <th class="all">COD</th>
                    ...
                    <th class="none">FECHA DE RECIBIDO</th>
                    <th class="min-desktop">NO. PRODUCTOS REQUERIDOS</th>
                    <th class="min-desktop">NO. PRODUCTOS DESIERTOS</th>                   
                    <th class="min-desktop">NO. PRODUCTOS OFERTADOS</th>
                    <th class="min-desktop">NO. PRODUCTOS RECOMENDADOS</th>
                    <th class="min-desktop">PRODUCTOS FRACASADOS</th>
                ...
                <tbody>	
					        <%
						        try{
							        ...
							        //String QueryString = "SELECT cod, procesoCompra, fecha, productosConOfertas, productosEstimados, productosCompletados, productosRecomendados, productosAnulados from dbo.vaciadoOfertasALP";
							        String QueryString = "select cod, procesoCompra, fecha, productosEstimados-productosAnulados as productosRequeridos, productosDesiertos, productosConOfertas, productosRecomendados, productosFracasados, productosCompletados from vaciadoOfertasALP ";
						      ...
						      %>
						        <tr>
							        ...
							        <td><%=rs.getInt(5)-rs.getInt(8)%></td>
							       <td><%=rs.getInt(5)-rs.getInt(8)-rs.getInt(4)%></td>							      
							       <td><%=rs.getInt(4)%></td>
							        <td><%=rs.getInt(7)%></td> 
							          <td><%=rs.getInt(5)-rs.getInt(8)-rs.getInt(7)%></td>  
