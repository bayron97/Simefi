...
<%
  ...
  String tipo = (String)request.getAttribute("modifTipo");
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
      ...
      <div class="content shadow-sm main-content-div">
        ...
        <div class="container main-container main-font" id="main-container">
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            ...
            <form id="editRegForm" action="distribuidorServlet" method="post">
                                ...
                                <div id="dataSection">
                                  <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                      <!--I. DATOS GENERALES section starts-->
                                      <div id="DGSection" class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="row hide" id="paisInputRow">
                                          <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                              <label>PAIS</label>
                                              <input
                                      ...
                                      <!--I. DATOS GENERALES section ends-->
                                    </div>
                                    <!--FILA #1 COLUMNA #1 ends-->

                                    <!--FILA #1 COLUMNA #2 starts-->
                                    <div class="col-lg-6 col-md-6">
                                      <!--II. DATOS CONSTITUCION section starts-->
                                      <div id="DCSection" class="card-body">
                                        <div class="row">
                                          <div class="col-lg-12 col-md-12">
                                            <h6
                                              id="instructionSubtitle"
                                          ...
                                          <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                              <input
                                                ...
                                                disabled
                                              />
                                              <label for="isFabricante">VOLVER FABRICANTE</label>
                                            </div>
                                          </div>
                                        </div>
                                        <% } else { %>
                                      ...
                                      <!--II. DATOS CONSTITUCION section ends-->
                                    </div>
              ...
              <input autocomplete="off" type="hidden" name="isModif" value="${isModif}">
		    		  ...
		    		  <input autocomplete="off" type="hidden" id="tipo" name="tipo" value="distribuidor">
		    		  <input autocomplete="off" type="hidden" id="modifTipo" name="modifTipo" value="${modifTipo}">
    ...
    <!-- Cancel Float Button -->
    <form method="post" action="distribuidorServlet">
    ...
    <script>
      ...
      $(document).ready(function () {
    	  ...
    	  if(error != null && !error.isEmpty()){    	
    		  %>
    		  $("#confirMessage").text("ERROR! EL RTN INGRESADO YA ESTA REGISTRADO. INGRESE UNO NUEVO");
      ...
      $("#isFabricante").on("change", function () {
        if ($("#isFabricante").prop("checked"))
        {
          $("#editRegForm #modifTipo").prop("value", "DISTRIBUIDOR/FABRICANTE");
          $("#editRegForm #tipo").prop("value", "distribuidor/fabricante");
          $("#editRegForm #paisInputRow").removeClass("hide");
          $("#pais").prop("required", true);
        }
        else
        {
          $("#editRegForm #modifTipo").prop("value", "DISTRIBUIDOR");
          $("#editRegForm #tipo").prop("value", "distribuidor");
          $("#editRegForm #paisInputRow").addClass("hide");
      ...
      $('input[name=rtn]').bind('keypress', function(event) {
