              ...
              <div class="container main-container">
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    ...
                    <h5 class="font-weight-light">CRITERIOS DE EVALUACION PARA PROCESO DE COMPRA</h5>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <form action="CriteriosEvaluacionPurchaseProcessServlet" method="post">
            ...
            >
              ...
              <tbody>
                <% try{ 
                  ...
                  con = DriverManager.getConnection(url,"admin","system123");
                  state = con.createStatement(); 
                  String QueryString = "select * from CriteriosEvaluacionPurchaseProcess order by idCE";
                  rs = state.executeQuery(QueryString); 
                %> <% while(rs.next()){  %>
                          <tr>
