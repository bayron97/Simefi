                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    <h2 class="mb-4 large-title">
                      REPORTE HISTORIAL DE USUARIO ESPECIFICO
                    </h2>
                    <h5 class="font-weight-light main-font">
                      PARAMETRIZACION / REPORTE HISTORIAL DE USUARIO
                    </h5>
                  </div>
                </div>
              </div>
                ...
                <div class="col-auto align-self-center main-font">
                  <form action="reportesServlet" method="post">
                    <button
                      ...
                      value="back"
                    >
                      <i class="material-icons md-18">arrow_back</i> REGRESAR
                    </button>
                  </form>
                </div>
              </div>
                ...
                <tbody>
                  <%
						        try{
							        ...
							        String QueryString = "select distinct codigoEmpleado, usuario, correo, puesto, nombre, identidad, funcion, observacion, estado1, estado2, fechaCreacion, fechaModificacion from dbo.reportesUsuario where codigoEmpleado = " + padre ;
                  ...
                  %>
                      ...
                      <%
                        ...
                        st.toUpperCase().contentEquals("INACTIVO")){
                      %>
                        <td>
