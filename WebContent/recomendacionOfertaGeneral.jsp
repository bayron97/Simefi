                ...
                <tbody>	
					        <%
						        try{
							        ...
							        String QueryString = "SELECT cod, procesoCompra, fecha, productosConOfertas, observaciones, productosEstimados, productosCompletados, productosRecomendados from dbo.vaciadoOfertasALP";
