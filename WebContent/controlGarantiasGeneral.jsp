  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
      ...
      <div class="content shadow-sm main-content-div">
        ...
        <div class="container main-container" id="main-container">
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	<form method="post" action="pControlGarantiasGeneral">
          	<input type="hidden" id="idControlGarantias" name="idControlGarantias"/>
            ...
            <div class="card-body main-font">
              ...
              <table
                ...
                aria-describedby="Tabla de control de garantias para ALP"
              >
                <thead>
                  <tr>
                    <th class="all">COD</th>
                    <th class="all">NO. PROCESO DE COMPRA</th>
                    <th class="all">NO. ORDEN DE COMPRA</th>
                    <th class="min-tablet">TIPO DE GARANTIA</th>
                    <th class="all">NO. DE GARANTIA</th>
                    <th class="min-desktop">FECHA DE EMISION</th>
                    <th class="min-desktop">FECHA DE CADUCIDAD</th>
                ...
                <%
			        try{
				        ...
				        String QueryString = "select CG.idControlGarantias, A.numProcesoCompra, CO.numDocumento,CG.tipoGarantia, CG.numGarantia, CG.fechaEmision,CG.fechaFinValidez,CG.estado1 from Gral.ControlGarantias CG inner join Gral.contratoOrdenCompra CO ON CG.idcontratoOrdenCompra = CO.idcontratoOrdenCompra  inner join Gral.aperturaProceso A ON  CO.idAperturaProceso = A.idAperturaProceso";
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#idControlGarantias").prop("value",value);
      });
    </script>
