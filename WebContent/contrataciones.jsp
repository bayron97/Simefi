          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            <div class="card-header border-0 bg-none">
              <div class="row">
                ...
                <form method="post" action="pContrataciones">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="all">COD. SISTEMA</th>
                    <th class="min-tablet">NO. PROCESO DE COMPRA</th>
                    <th class="min-tablet">BENEFICIARIO</th>
                    <th class="min-tablet">NO. SOLICITUD COMPRA</th>
                    <th class="min-tablet">PROVEEDOR</th>
                    <th class="min-tablet">NO. ORDEN DE COMPRA</th>
                    <th class="min-tablet">VALOR ORDEN DE COMPRA</th>
                    <th class="min-tablet">FECHA DE SUSCRIPCION ORDEN DE COMPRA</th>
                ...
                <%
			        try{
				        ...
				        String QueryString = "SELECT * FROM contrataciones";
			      ...
			      %>
						        <tr>
							        ...
							        <td><%=rs.getString(9).toUpperCase()%></td>
							         ...
							         <td><%=rs.getInt(14)%></td>
			                <td><%=rs.getString(11).toUpperCase()%></td>
