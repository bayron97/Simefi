        ...
        <div class="col-md-12">
			...
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
				...
				<li class="nav-item"><a class="nav-link"
					...
					href="#canProduct" role="tab"
					aria-controls="pills-profile" aria-selected="false">PRODUCTOS CANCELADOS</a></li>
				</ul>
				...
				<div class="tab-pane fade show active" id="recProduc" role="tabpanel" aria-labelledby="pills-home-tab">
						...
						<form id="newEditRegForm" action="recepcionProductosServlet" method="post">
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6">
													<div class="form-group" style="text-align: left">
														...
														<input type="text" id="proveedor"  class="form-control" name="proveedor" value="${nombreproveedor}" />
												...
												<div class="col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="hidden"
															...
															<input type="text" id="solicitudcompra"  class="form-control" name="solicitudcompra" value="${nombresolicitudcompra}" />
              ...
              <!--Table Section ends-->
								...
								<div class="col-md-12">
									<div id="dataSection">
												...
												<div class="row">
													<div class="col-lg-6 col-md-6">
														<div class="form-group">
															...
															<input type="text"  onkeyup="format(this)" id="cantidadentregada" name="cantidadentregada" class="form-control" />
														</div>
													</div>
													<div class="col-lg-6 col-md-6">
														<div class="form-group">
															<label>TOTAL ENTREGADO</label> 
															<input type="text" readonly="readonly" id="totalentregado" name="totalentregado" class="form-control" />
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4 col-md-4">
														<div class="form-group">
															...
															<input type="text" id="diasatraso" name="diasatraso" class="form-control" />
														</div>
													</div>
													<div class="col-lg-5 col-md-5">
														<div class="form-group">
															<label>MULTA POR ENTREGA TARDIA (5% MENSUAL)</label> 
															<input type="text" readonly="readonly" id="multaentrega" name="multaentrega" class="form-control" />
														</div>
													</div>
													<div class="col-lg-3 col-md-3">
														<div class="form-group">
															<label>VALOR NETO A PAGAR</label> 
															<input type="text" id="valorneto" name="valorneto" class="form-control" />
														</div>
													</div>
												</div>
											</div>
										...
										<input type="button" id="CancelarItem"  value="Cancelar item Recepcion" class="btn btn-sm btn-success ml-2">
   ...
   <div
	...
	<% if (funcion != null && !funcion.contentEquals("nuevo")) {%>
		var ordencomprainput = $("#ordencompra");
							...
							reqTable.ajax.url(getAbsolutePath()+ "RecepcionProductos"+ "?submit=Consultar&id="+ $("#Id").val()).load();							
							reqTableCancelados.ajax.url(getAbsolutePath()+ "RecepcionProductosCanceladosApi"+ "?submit=Consultar&id="+ $("#Id").val()).load();					
	<% } %>
	
			
			var Item = [];
			var precioparacalculo = 0;
			
			$("#cantidadentregada").change(function () {				
				precioparacalculo = precioparacalculo.replaceAll(',', '');			
				
				document.getElementById('totalentregado').value= ((precioparacalculo)*  parseInt($(this).val().replaceAll(',', '')));	
			});

			$("#diasatraso").change(function () {				
				var totalentregado = document.getElementById("totalentregado").value; 		
				
				var totaluno = parseFloat(parseInt($(this).val())*  parseFloat(totalentregado));
				 
				document.getElementById('multaentrega').value = (totaluno*0.5)/30;	
				
				var totalneto = (totalentregado - document.getElementById("multaentrega").value);
				
				document.getElementById('valorneto').value = totalneto.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","); 	
			...
			$("#reqTable tbody").on("click", "tr", function () {
		        ...
		        precioparacalculo =  $(this).find("td:eq(11)").text();
			  ...
			  $("#ActualizarItem").on("click", function (event) {
		      	...
		      	if ($("#noItem").val() === "" || $("#noItem").val() == 0 || $("#noItem").val() === "No hay datos disponibles en la tabla.") {				 
		           ...
		           var url = getAbsolutePath() + "ContratacionesNewItemValidate";		          
			  ...
			  $("#CancelarItem").on("click", function (event) {
			      	...
			      	if ($("#noItem").val() === "" || $("#noItem").val() == 0 || $("#noItem").val() === "No hay datos disponibles en la tabla.") {				 
						 ...
						 $("#confirMessage").text("SELECCIONE UN ITEM VALIDO...");
			      		 ...
			      		 $("#confirmationModalCenter").modal('show');				 				 
						 $("#confirMessage").text("CANCELANDO ITEM POR FAVOR ESPERE...");
		...
		$("#ordencompra").change(
		 ...
		 $('input[name=nofactura]').bind('keypress', function(event) {
		...
		$('input[name=diasatraso]').bind('keypress', function(event) {
	    	  var regex = new RegExp("^[0-9]+$");
	    	  var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
	    	  if (!regex.test(key)) {
	    	    event.preventDefault();
