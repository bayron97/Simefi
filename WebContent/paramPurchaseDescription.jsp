  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <input class="hide" type="submit" id="paramCriterioEvaluacionVaciado" name="submit" value="paramCriterioEvaluacionVaciado" />
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="#">TIPO DE COMPRA</a>
                        <label class="dropdown-item" for="Fabricante">FABRICANTE</label>
                        <label class="dropdown-item" for="paramCriterioEvaluacionVaciado">CRITERIOS DE EVALUCION PARA VACIADO DE OFERTAS</label>
                      </div>
                    </div>
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#">TIPO DE COMPRA</a>
                      </li>
                     <!--  <li class="nav-item">
                        <label class="nav-link" for="Fabricante">FABRICANTE</label>
                      </li> -->
                      <li class="nav-item">
                        <label class="nav-link" for="paramCriterioEvaluacionVaciado">CRITERIOS DE EVALUCION PARA VACIADO DE OFERTAS</label>
                      </li>
                    </ul>
                  </form>
                </nav>
            ...
            <div class="card-body main-font">
              ...
              >
                <thead>
                  <tr>
                    <th class="all">NO.</th>
                    <th hidden class="all">NO.</th>
                    <th class="min-tablet">NOMBRE COMPRA</th>
                    <th class="min-desktop">ESTADO</th>
                    <th class="min-desktop">MOTIVO</th>
                  </tr>
                </thead>
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT no, nombrecompra, estado, motivo from dbo.descripcioncompra";
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-left">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="paramPurchaseType">
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-right">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="paramCriterioEvaluacionVaciado">
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form action="descripcioncompraServlet" id="editRegForm" method="post" >
                              ...
                              >
                                ...
                                <div class="row">
                                  <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                      <input type="checkbox" id="checkActivo" name="checkActivo"/>
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#BTID").prop("value", value);
        value = $(this).find("td:eq(2)").text();
        $("#nombrec").prop("value", value);
