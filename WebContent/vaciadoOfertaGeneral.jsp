 ...
 <% } %>
            ...
            <div class="card-header border-0 bg-none">
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  ...
                  <form action="ofertasGeneralRouting" method="post" id="buttonsSection" class="hide">
                  ...
                  >
                    <i class="material-icons md-18">done_all</i> CONTROL DE OFERTA
                  </button>
                  <button 
                    id="newOfertas"
                  	class="btn btn-sm btn-success ml-2"
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-desktop">NO. PRODUCTOS CON OFERTAS RECIBIDAS</th>
                ...
                <tbody>	
					        <%
						        try{
							        ...
							        String QueryString = "SELECT cod, procesoCompra, fecha, productosConOfertas, observaciones, productosEstimados, productosCompletados from dbo.vaciadoOfertasGeneral";
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="offerControlContent" action="ofertaGeneralServlet" method="post">
            ...
            <div class="modal-body" style="background-color: #f1f1f1;">
              ...
              <div class="text-center pb-5">
                <h1 class="mb-0 text-white">
                  CANTIDAD DE MEDICAMENTOS ESTIMADOS POR PROCESO DE COMPRA
                </h1>
                <h4
                  id="subtitleChange"
    ...
    <script>
      ...
      function errorCheck() {
        ...
        if (openMode === "error")
        {
          alert("Error! Se debe seleccionar un registro de la tabla para usar las funciones Modificar o Consultar!");
        }
      };
      ...
      $(document).ready(function () {
        ...
        $("#offerControlButton").on("click", function () {
          ...
          $.post('generalBuyPurchaseDescriptionAPI', {
				    search : searchValue,
			    }, function(responseText) {
				    $("#buyProcessDescriptionForModal").prop("value", responseText);
			    });
          offerControlTable.ajax.url(getAbsolutePath() + "GeneralListaRequerimientosAPI?search=" + searchValue).load();
        });
        ...
        $("#submitOffersControl").on("click", function () {
          ...
          if(table.rows.length > 0){
              ...
              inputATC.setAttribute("name", "codATC");
	            if(table.rows[r].cells[2].innerHTML){
	              inputATC.setAttribute("value", table.rows[r].cells[2].innerHTML);
	            }
