  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
      ...
      <div class="content shadow-sm main-content-div">
        ...
        <div class="container main-container" id="main-container">
                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    <h2 class="mb-4 large-title">
                      ACLARACIONES Y ENMIENDAS PARA PROCESO DE COMPRA
                    </h2>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	...
          	<input type="hidden" id="idAclaracionEnmienda" name="idAclaracionEnmienda"/>
            ...
            <div class="card-body main-font">
              ...
              <table
                ...
                aria-describedby="Tabla de Aclaraciones y Enmiendas para General"
              >
                <thead>
                  <tr>
                    <th class="hide">COD</th>
                    <th class="all">NO. PROCESO DE COMPRA</th>
                    <th class="min-desktop">FECHA ENMIENDA / ACLARACIÓN</th>
                    <th class="min-desktop">TIPO DE DOCUMENTO</th>
                    <th class="min-desktop">CORRELATIVO DE TIPO DE DOCUMENTO</th>
                ...
                <tbody>
						        ...
						        try{
							      ...
							      String QueryString = "select AE.idAclaracionEnmienda ,AE.idAperturaProceso,AP.numProcesoCompra,AE.fecha,AE.aclaracionEnmienda, AE.correlativoEnmienda, AE.observaciones from Gral.aclaracionEnmienda AE inner join Gral.aperturaProceso AP on AE.idAperturaProceso = AP.idAperturaProceso";
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#idAclaracionEnmienda").prop("value",value);
      });
    </script>
