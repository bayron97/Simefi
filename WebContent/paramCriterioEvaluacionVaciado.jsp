  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  <form method="post" action="pCompraParamRouting">
                    <input class="hide" type="submit" id="openingPlaceRouteButton" name="submit" value="paramOpeningPlace"/>
                    <input class="hide" type="submit" id="purchaseTypeRouteButton" name="submit" value="paramPurchaseType" />
                    <input class="hide" type="submit" id="ALPRouteButton" name="submit" value="paramALP" />
                    <input class="hide" type="submit" id="Fabricante" name="submit" value="Fabricante" />
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        <label class="dropdown-item" for="openingPlaceRouteButton">LUGAR DE APERTURA</label>
                        <label class="dropdown-item" for="purchaseTypeRouteButton">MECANISMOS DE COMPRA</label>
                        <label class="dropdown-item" for="ALPRouteButton">TIPO DE COMPRA</label>
                        <label class="dropdown-item" for="Fabricante">FABRICANTE</label>
						            <a class="dropdown-item active" href="#">CRITERIOS DE EVALUCION PARA VACIADO DE OFERTAS</a>
                      </div>
                    </div>
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      <li class="nav-item">
                        <label class="nav-link" for="openingPlaceRouteButton">LUGAR DE APERTURA</label>
                      </li>
                      <li class="nav-item">
                        <label class="nav-link" for="purchaseTypeRouteButton">MECANISMOS DE COMPRA</label>
                      </li>
                      <li class="nav-item">
                        <label class="nav-link" for="ALPRouteButton">TIPO DE COMPRA</label>
                      </li>
                      <!-- <li class="nav-item">
                        <label class="nav-link" for="Fabricante">FABRICANTE</label>
                      </li> -->
                      <li class="nav-item">
                        <a class="nav-link active" href="#">CRITERIOS DE EVALUCION PARA VACIADO DE OFERTAS</a>
                      </li>
                    </ul>
                  </form>
                </nav>
                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    ...
                    <h5 class="font-weight-light main-font">
                      CRITERIO DE EVALUCION PARA VACIADO DE OFERTA
                    </h5>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body main-font">
              ...
              >
                <thead>
                  <tr>
                    <th class="all">#</th>
                    <th hidden class="all">#</th>
                    <th class="min-tablet">CRITERIOS DE EVALUCION</th>     
                ...
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.CriteriosEvaluacion";
						...
						<tr>
							...
							<%if(estado == null || estado.isEmpty() || estado.contentEquals("INACTIVO")){
							%>
							  <td>
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-left">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="Fabricante">
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="CriterioEvaluacionServlet">
            ...
            <div class="modal-body" style="background-color: #f1f1f1;">
              ...
              <div class="text-center pb-5">
                <h1 class="mb-0 text-white">
                  PARAMETRIZACION APERTURA DE PROCESOS
                </h1>
                <h4
                  id="subtitleChange"
                                ...
                                <div class="row">
                                  <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                      <label>NOMBRE CRITERIO DE EVALUACION*</label>
                                      <input
                                        autocomplete="off"
                                        type="text"
                                        class="form-control"
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#NombreCriterio").prop("value", value); 
        value = $(this).find("td:eq(4)").text();
        $("#motivo").prop("value", value);         
        value = $(this).find("td:eq(1)").text();
        $("#idEditar").prop("value", value); 
        value = $(this).find("td:eq(3) div").text();
      ...
      $("#changeStateButton").on("click", function () {
        ...
        if (value === "") {
          ...
          document.getElementById("submitButton").value = "activar";
          $("#subtitleChange").text("CAMBIAR ESTADO");
          $("#infoIcon").text("format_shapes");
          $("#editRegForm #errorSection").addClass("hide");
          $("#instructionSubtitle").removeClass("hide");
    ...
    $("#submitButton").on("click",function(event) {
  	  ...
  	  if(this.value == "activar"){
  		 ...
  		 document.getElementById("SaveData").value = "activar";
  		  $("#SaveData").trigger(
				"click");
			...
			var CrEvaluacion = document.getElementById("NombreCriterio").value;			
			var validar = "ValidarCriterio";
			var modifId = 0;
			$.ajax({
						url : url,
						type : "POST",
						...
						success : function(data) {
							...
							if (parseInt(data) == 0) {	
								document.getElementById("SaveData").value = "nuevo";
								$("#SaveData").trigger(
								"click");
								return true;
							} else {
								$("#confirMessage")
										.text(
												"ALERTA! ESTE CRITERIO YA SE A REGISTRADO PREVIAMENTE");
