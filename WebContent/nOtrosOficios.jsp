...
<%
  String revisar =(String)request.getAttribute("isRev");
	...
	String isMod = (String)request.getAttribute("isModify");
	String mod = "";
      ...
      <div class="content shadow-sm main-content-div">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  ...
                  <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                    <li class="nav-item">
                      <a class="nav-link" href="#">OTROS INSUMOS</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container main-container" id="main-container">
          ...
          <div class="main-content-div main-font">
            <form id="newEditRegForm" action="otrosOficioServlet" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-12 col-md-12">
                  ...
                  <div class="row mt-3 mb-4">
			        ...
			        try{
				        ...
				        String QueryString = "SELECT * FROM otroOficios where Idotro = "+id;
			      ...
			      %>
						        <tr>
							        ...
							        <td><%=rs.getString(2).toUpperCase()%></td>
                      			    <td><a href="assets/files/otherFiles/<%=rs.getString(3)%>" target="_blank"><%=rs.getString(3).toUpperCase()%></td>
						        </tr>
			      <%}
			        rs.close();
			        state.close();
	...
	<div class="modal fade main-font" id="revAprovReg" tabindex="-1"
		...
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<form action="otrosServlet" id="revAprovRegForm" method="post">
				<input type="hidden" name="modifId" id="id" value="${id}">
													...
													<div class="col-md-10 mx-auto">
														...
														<div id="stateSection"
															...
															try {
																...
																String es1 = "";
																String es2 = "";
																String QueryString = "SELECT estado1, estado2 from dbo.otros where num = " + n;
																rs = state.executeQuery(QueryString);
																while (rs.next()) {
																	es1 = rs.getString(1);
																	es2 = rs.getString(2);
      ...
      $(document).ready(function () {
        ...
        $("#addLegalButton").click(function () {
        	if($("#legalFileNo").val()){
            	...
            	y.innerHTML = "${id}__"+$("#legalFileNo").val()+".pdf"; 
            	z.innerHTML =contador;

           	 	lTable.row.add([contador, 
           	 					$("#legalFileNo").val().toUpperCase(), 
           	 					"${id}_"+$("#legalFileNo").val().toUpperCase()+".pdf"]).draw();
