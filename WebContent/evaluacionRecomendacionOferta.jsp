      ...
      <div class="content shadow-sm main-content-div">
                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-12">
                    <h2 class="mb-4 large-title">
                      EVALUACION Y RECOMENDACION DE OFERTAS
                    </h2>
		...
		%>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            <form action="evaluacionRecomendacionALPInit" method="post">
              ...
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  <div class="form-group float-right" id="instructionsMessage">
                    <label class="mr-3">NOTA: PARA EMPEZAR A EVALUAR SELECCIONE UNA SOLICITUD DE COMPRA DE LA TABLA</label>
                  </div>
                  ...
                  <button
                    ...
                    value="modificar"
                  >
                    <i class="material-icons md-18">add_circle</i> EVALUACIONES Y RECOMENDACIONES
                  </button>
                   <%} %>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-desktop">NO. ITEM RECOMENDADOS</th>
