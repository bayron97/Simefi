  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
                  ...
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="#">FABRICANTE</a>
                    ...
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#">FABRICANTE</a>
                      </li>
                      <li class="nav-item">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">NOMBRE FABRICANTE</th>
                ...
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.fabricantes";
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form action="fabricantesServlet" id="editRegForm" method="post" >
