                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    <h2 class="mb-4 large-title">
                      REPORTE HISTORIAL DE ACCESOS
                    </h2>
                    <h5 class="font-weight-light main-font">
                      PARAMETRIZACION / REPORTE HISTORIAL DE ACCESOS
                    </h5>
                  </div>
                </div>
              </div>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">MODULO</th>
                    <th class="min-tablet">SUBMODULO</th>
                ...
                <tbody>
                  <%
						        try{
							        ...
							        String QueryString = "select * from dbo.reportesAccesos where usuario = '" + usuario + "'";
