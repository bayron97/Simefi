  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
      ...
      <div class="content shadow-sm main-content-div">
                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-12">
                    ...
                    <h5 class="font-weight-light main-font">
                      COMPRA ACUERDO A LARGO PLAZO (ALP)
                    </h5>
                  </div>
                </div>
              </div>
		...
		%>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            <form action="ratificacionCTFALPInit" method="post">
            <input type="hidden" id="requestBuyCOD" name="requestBuyCOD" />
              ...
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  <div class="form-group float-right" id="instructionsMessage">
                    <label class="mr-3">NOTA: PARA EMPEZAR A RATIFICAR SELECCIONE UNA SOLICITUD DE COMPRA DE LA TABLA</label>
                  </div>
                  ...
                  <button
                    ...
                    value="modificar"
                  >
                    <i class="material-icons md-18">add_circle</i> PROVEEDORES & RATIFICACIONES
                  </button>
                  <%} %>
            ...
            <div class="card-body main-font">
              ...
              <table
                ...
                aria-describedby="Tabla de recomendaciones y evaluaciones"
              >
                <thead>
                  <tr>
                    <!-- <th class="all">NO.</th>
                    ...
                    <th class="none">ULTIMA FECHA DE EVALUACION Y RECOMENDACION</th>
                    <th class="min-desktop">NO. ITEMS REQUERIDOS</th>
                    <th class="min-desktop">NO. ITEMS OFERTADOS</th>
                    <th class="min-desktop">NO. PROVEEDORES PARTICIPANDO</th>
                    <th class="min-desktop">NO. OFERTAS RECIBIDAS</th>
                    <th class="none">NO. ITEMS SIN OFERTAS</th>
                    <th class="min-desktop">NO. OFERTAS RECOMENDADAS</th>
                    <th class="none">NO. OFERTAS NO RECOMENDADAS</th>
                    <th class="min-desktop">ESTADO</th>
                    <th class="none">OBSERVACIONES</th> -->
                    <th class="all">NO.</th>
                    <th class="min-tablet">NO. PROCESO DE COMPRA</th>
                    <th class="min-desktop">NO. SOLICITUD DE COMPRA</th>                    
                    <th class="min-desktop">NO. ITEMS RECOMENDADOS</th>
                    <th class="min-desktop">PROVEEDORES RECOMENDADOS</th>
                    <th class="min-desktop">NO. ITEMS RATIFICADOS</th>
                    <th class="min-desktop">NO. ITEMS NO RATIFICADOS</th>
                    <th class="min-desktop">NO. ITEMS PENDIENTES</th>
                ...
                <tbody>
                  <%
						        try{
							       ...
							       // String QueryString = "SELECT id, noProcesoCompra, codSolicitudCompra, fecha, noItemsRequeridos, noItemsOfertados, noProveedoresParticipando, noOfertasRecibidas, noOfertasRecomendadas, estado, observaciones from dbo.vaciadoEvaluacionRecomendacionALP";
							        String QueryString = "select verALP.id, verALP.noProcesoCompra, verALP.codSolicitudCompra, COUNT(CASE WHEN estadoCompra='EVALUACION REALIZADA' THEN 0 END) AS itemRecomendados, COUNT(CASE WHEN estadoCompra='EVALUACION REALIZADA' THEN 0 END) AS proveedoresRecomendados, COUNT(CASE WHEN ratificacionCT='RATIFICADO' THEN 0 END) AS itemsRatificados, COUNT(CASE WHEN ratificacionCT='NO RATIFICADO' THEN 0 END) AS itemsNORatificados, COUNT(CASE WHEN ratificacionCT='PENDIENTE' THEN 0 END) AS pendientes from vaciadoEvaluacionRecomendacionALP as verALP inner join solicitudCompraALP as sALP  on verALP.noProcesoCompra = sALP.noProcesoCompra and  verALP.codSolicitudCompra = sALP.codSolicitudCompra INNER JOIN solicitudDisponibilidadALP AS sdALP on sdALP.idSolicitudCompra = sALP.id inner join listaRequerimientoSolicitudDisponibilidadALP as lrsdALP on lrsdALP.idSolicitudDisponibilidad = sdALP.id group by verALP.id, verALP.noProcesoCompra, verALP.codSolicitudCompra";
                      ...
                      int noItemsRequeridos = rs.getInt(5);
                      int noItemsOfertados = rs.getInt(6);
                      int noProveedoresParticipando = rs.getInt(7);
                      int noOfertasRecibidas = rs.getInt(8);
                      int noItemsSinOfertas = noItemsRequeridos - noItemsOfertados;
                      int noOfertasRecomendadas = rs.getInt(9);
                      int noOfertasNoRecomendadas = noOfertasRecibidas - noOfertasRecomendadas;
                      ...
                      <td><%=fecha.toUpperCase()%></td>
							        <td><%=noItemsRequeridos%></td>
                      <td><%=noItemsOfertados%></td>
                      <td><%=noProveedoresParticipando%></td>
                      <td><%=noOfertasRecibidas%></td>
                      <td><%=noItemsSinOfertas%></td>
                      <td><%=noOfertasRecomendadas%></td>
                      <td><%=noOfertasNoRecomendadas%></td>
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#requestBuyCOD").prop("value",value);
      });
    </script>
