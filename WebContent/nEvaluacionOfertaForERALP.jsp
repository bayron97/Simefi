...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  ...
                  <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="#">EVALUACION</a>
                    </li>
                    <li class="nav-item">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12">
                  <div class="form-group float-left">
                    <h6 class="mb-4">
                      NOTA: PARA INICIAR LA EVALUACION SELECCIONE UNA OFERTA...
                    </h6>
                  </div>
                  <div
            ...
            <div class="card-body main-font">
                ...
                >
                  <thead>
                    <tr>
                      ...
                      <th hidden class="min-desktop">CRITERIO REGISTRO SANITARIO</th>
                      <th hidden class="min-desktop">CRITERIO DE CANTIDAD</th>
                      <th hidden class="min-desktop">
                        CRITERIO DE CERTIFICACION DE BUENAS PRACTICAS DE
                        MANUFACTURA
                      </th>
                      <th hidden class="min-desktop">CRITERIO DE TIEMPO DE ENTREGA</th>
                      <th hidden class="min-desktop">CRITERIO DE VIDA UTIL</th>
                      <th class="min-desktop">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><%=req.getNoItem()%></td>
                      <td><%=req.getCodigoATC().toUpperCase()%></td>
                      ...
                      <td><%=req.getCantidadOfertada()%></td>
                      <td><%=req.getPrecioUnitarioAcordado()%></td>
                      <td><%=req.getPrecioTotal()%></td>
                      <td><%=req.getMoneda().toUpperCase()%></td>
                      <td><%=req.getTiempoEntregaOfertado().toUpperCase()%></td>
                      <td><%=req.getVidaUtilOfertada().toUpperCase()%></td>
                      <td><%=req.getCantidadEmpaquePrimario()%></td>
                      <td><%=req.getCantidadEmpaqueSecundario()%></td>
                      <td hidden><%=req.getRegSanCriterio().toUpperCase()%></td>
                      <td hidden><%=req.getCantCriterio().toUpperCase()%></td>
                      <td hidden><%=req.getCertBPMCriterio().toUpperCase()%></td>
                      <td hidden><%=req.getTiempoEntregaCriterio().toUpperCase()%></td>
                      <td hidden><%=req.getVidaUtilCriterio().toUpperCase()%></td>
              ...
              <div class="card-body main-font mt-1">
                <form id="evaluateForm">
                  <div class="collapse show" id="advertenciaEvaluacion">
                    <div class="row">
                      <div class="col-lg-12 col-md-12">
                  ...
                  <div class="collapse" id="evaluacion">
                    <input type="hidden" id="noItem" name="noItem" />
                     <input type="hidden" id="SDID" name="SDID" />
                    <!-- <div class="row">
                      <div class="col-lg-12 col-md-12">
                        <div class="form-group float-left">
                          <h5 class="mb-4">
                            <u>CRITERIOS PARA EVALUACION DE OFERTA</u>
                          </h5>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                          <label>1. CANTIDAD</label>
                        </div>
                      </div>
                      <div class="col-lg-8 col-md-8">
                        <div class="form-group">
                          <select id="cantidadCriterio" name="cantidadCriterio" class="form-control">
                            <option value="CUMPLE">CUMPLE</option> 
                            <option value="NO CUMPLE">NO CUMPLE</option>
                            <option value="CUMPLE CON VARIACION">CUMPLE CON VARIACION</option>
                          </select>  
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                          <label>2. REGISTRO SANITARIO</label> 
                        </div>
                      </div>
                      <div class="col-lg-8 col-md-8">
                        <div class="form-group">
                          <select id="regSanCriterio" name="regSanCriterio" class="form-control">
                            <option value="CUMPLE">CUMPLE</option> 
                            <option value="NO CUMPLE">NO CUMPLE</option>
                            <option value="CUMPLE CON VARIACION">CUMPLE CON VARIACION</option>
                          </select> 
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                          <label>3. CERTIFICADO DE BUENAS PRACTICAS DE MANUFACTURA</label>
                        </div>
                      </div>
                      <div class="col-lg-8 col-md-8">
                        <div class="form-group">
                          <select id="certBPMCriterio" name="certBPMCriterio" class="form-control">
                            <option value="CUMPLE">CUMPLE</option> 
                            <option value="NO CUMPLE">NO CUMPLE</option>
                            <option value="CUMPLE CON VARIACION">CUMPLE CON VARIACION</option>
                          </select>  
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                          <label>4. TIEMPOS DE ENTREGA</label>
                        </div>
                      </div>
                      <div class="col-lg-8 col-md-8">
                        <div class="form-group">
                          <select id="tiempoEntregaCriterio" name="tiempoEntregaCriterio" class="form-control">
                            <option value="CUMPLE">CUMPLE</option> 
                            <option value="NO CUMPLE">NO CUMPLE</option>
                            <option value="CUMPLE CON VARIACION">CUMPLE CON VARIACION</option>
                          </select>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                          <label>5. VIDA UTIL</label>
                        </div>
                      </div>
                      <div class="col-lg-8 col-md-8">
                        <div class="form-group">
                          <select id="vidaUtilCriterio" name="vidaUtilCriterio" class="form-control">
                            <option value="CUMPLE">CUMPLE</option> 
                            <option value="NO CUMPLE">NO CUMPLE</option>
                            <option value="CUMPLE CON VARIACION">CUMPLE CON VARIACION</option>
                          </select>  
          ...
          <div class="card text-center shadow-sm border-0">
            <div class="card-body" style="background: url(BAC.png) no-repeat center center">
              ...
              <div class="modal-body main-font" id="newRegConfirMessage">
                &#191;DESEA GUARDAR ESTOS CRITERIOS PARA ESTA OFERTA?
              </div>
              <div>
                <div class="row">
 ...
 <div class="modal fade " id="Espera" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content box-shadow">
          <div class="card text-center shadow-sm border-0">
            <div class="card-body" style="background: url(BAC.png) no-repeat center center">
              ...
              <div class="modal-body main-font mt-2" id="confirMessage">
                POR FAVOR ESPERE. CARGANDO CRITERIOS Y OPCIONES...
              </div>              
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      function cleanFields(){
        $("#regSanCriterio").prop("value", "NO CUMPLE");
        $("#cantidadCriterio").prop("value", "NO CUMPLE");
        $("#certBPMCriterio").prop("value", "NO CUMPLE");
        $("#tiempoEntregaCriterio").prop("value", "NO CUMPLE");
        $("#vidaUtilCriterio").prop("value", "NO CUMPLE");
      }
      ...
      $(document).ready(function () {
        ...
        $("#confirmModalButton").on("click", function (event) {
          ...
          var i = document.getElementById('criteriosEvalaucionTableParam').getElementsByTagName('tr').length - 1;
          if(i == 0){
        	  $("#confirMessage").text("NO SE A SELECCIONADO NINGUN ITEM");
              $("#confirmationModalCenter").modal('show');
        	  return false;
          }else{
          $("#newRegModalCenter").modal('hide');

          $("#confirMessage").text("GUARDANDO REGISTRO, PORFAVOR ESPERE...");
          $("#confirmationModalCenter").modal('show');

          var url = getAbsolutePath() + "ALPManageEvaluateOffersForERAPI" + "?mode=new";
          ...
          $.ajax({
            ...
            success: function(data)          
            {
              console.log(data);
              if (data === "successful"){
                //reqTable.ajax.url(getAbsolutePath() + "ALPManageEvaluateOffersForERAPI").load();              
        ...
        $("#reqTable tbody").on("click", "tr", function () {
            ...
            ObtenerCriteriosOpciones(value)
            ...
            $("#advertenciaEvaluacion").collapse("hide");
            $("#evaluacion").collapse("show");
          });
        
 		function ObtenerCriteriosOpciones(id) {    	 			
 			<%  String idSolicitud = (String)request.getAttribute("SDID");%>  			
 			reqTableCriterios.ajax.url(getAbsolutePath() + "ObtenerCriteriosEvaluacionOpcionesAPI" + "?id=" + id +  "&idSolicitud=" + <%=idSolicitud%>).load();
 			$("#Espera").modal('hide');
 		}          
      });      
