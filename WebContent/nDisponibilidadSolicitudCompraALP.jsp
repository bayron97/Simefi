...
<%
  ...
  ArrayList<listaRequerimientoSolicitudCompraALP> reqProductSuppliers = (ArrayList<listaRequerimientoSolicitudCompraALP>) request.getAttribute("reqProductSuppliers");
  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  ...
                  <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="#">SOLICITUD DE DISPONIBILIDAD</a>
                    </li>
                  </ul>
                </nav>
                </form>
        ...
        <div class="container main-container" id="main-container">
          ...
          <div class="main-content-div main-font">
            ...
            %>
              ...
              <input type="hidden" id="productos" name="productos" value="${productos}">
              <input type="hidden" name="id" value="<%=codPadre%>">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="row mb-4">
                    <div class="col-lg-12 col-md-12">
                      ...
                      >
                        SOLICITUD DE DISPONIBILIDAD: NUEVO REGISTRO
                      </h5>
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-lg-8 col-md-8">
                      ...
                      >
                        ...
                        <%
                          for(listaRequerimientoSolicitudCompraALP requerimiento : reqProductSuppliers){
                        %>
                          <option value="<%=requerimiento.getProveedor().toUpperCase()%>">
                            <%=requerimiento.getProveedor().toUpperCase()%>
                          </option>
                        <%
                          }
                        %>
                  ...
                  <div class="row mt-3">
                    <div class="col-lg-4 col-md-4">
                      <label>2) NO. SOLICITUD DISPONIBILIDAD*</label>
                    </div>
                    <div class="col-lg-8 col-md-8">
                      <input
                        autocomplete="off"
                  ...
                  <div class="row mt-3">
                    <div class="col-lg-4 col-md-4">
                      <label>3) FECHA DE EMISION*</label>
                    </div>
                    <div class="col-lg-8 col-md-8">
                      <input
                        autocomplete="off"
                  ...
                  <div class="row mt-3">
                    <div class="col-lg-4 col-md-4">
                      <label>4) FECHA MAXIMA DE RESPUESTA*</label>
                    </div>
                    <div class="col-lg-8 col-md-8">
                      <input
                        autocomplete="off"
                ...
                <div class="col-lg-12 col-md-12">
                  <div class="form-group float-right mr-2">
                    ...
                    <button
                      ...
                      data-toggle="modal"
                    >
                      <i class="material-icons md-18">done</i>GENERAR SOLICITUD
                    </button>
                  </div>
                </div>
              </div>
              <div class="row mt-4">
                <div class="col-lg-12 col-md-12">
                  <div class="row">
                    <div class="col-lg-12 col-md-12">
                      <h5>SOLICITUD DE DISPONIBILIDAD: PRODUCTOS REGISTRADOS</h5>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12 col-md-12">
                      ...
                      >
                        <thead>
                          <tr>
                            ...
                            <th class="min-desktop">DISTRIBUIDOR</th>
                            ...
                            <th class="min-desktop">CERTIFICADO DE BUENAS PRACTICAS DE MANUFACTURA (BPM)</th>                            
                            <th class="min-desktop">FECHA VENCIMIENTO</th>
                            <th class="min-desktop">FECHA EMISION</th>
                            ...
                            <th class="min-tablet">SELECTOR</th>
                          </tr>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <div class="modal-content box-shadow">
          <div class="card text-center shadow-sm border-0">
            <div class="card-body" style="background: url(BAC.png) no-repeat center center">
              ...
              <div>
                <a
                  class="btn btn-primary btn-block main-font hide"
                  id="downloadReportModalButton"
                  href="#"
                  target="_blank"
                >
                  DESCARGAR REPORTE PDF <i class="material-icons md-18">picture_as_pdf</i>
                </a>
              </div>
              <div>
                <button 
    ...
    <script>
      ...
      function cleanFields(){
        ...
        //$("#noSolicitud").prop("readonly", true);
        $("#fechaEmision").prop("value", "");
        $("#fechaEmision").prop("readonly", true);
        $("#maxFechaEnt").prop("value", "");
        $("#maxFechaEnt").prop("readonly", true);
        $("#notaSol").prop("value", "");
        $("#notaSol").prop("readonly", true);
      }

      $(document).ready(function () {

        /*Tabla de medicamentos requeridos*/
          ...
          if (
           $("#proveedor").prop("value") === "NINGUNO" ||
            ...
            $("#confirMessage").text(
        	  ...
        	  var url = getAbsolutePath() + "SolicitudCompraALPAPI" + "?accion=validarNoSolicitudDisponibilidad";
        	  ...
        	  console.log($("#newEditRegForm").serialize())
                ...
                success: function(data)          
                {
                  ...
                  if (data == "0"){ 
                	///-------
                 var url = getAbsolutePath() + "ALPManageSDforSCAPI" + "?mode=new";
                	  ...
                	  $("#confirMessage").text("ERROR! ESTE NUMERO DE SOLICITUD DE DISPONIBILIDAD YA ESTA INGRESADO PARA ESTA SOLICITUD DE COMPRA");
                      $("#confirmationModalCenter").modal('show');
                  }
                },
                error : function() {
        ...
        $("#proveedor").on("change", function (){
          ...
          if (elementValue === "NINGUNO"){
            $("#fechaEmision").prop("readonly", true);
            $("#maxFechaEnt").prop("readonly", true);
            $("#notaSol").prop("readonly", true);
          }
          else{
            $("#fechaEmision").prop("readonly", false);
            $("#maxFechaEnt").prop("readonly", false);
            $("#notaSol").prop("readonly", false);
            reqTable.ajax.url(getAbsolutePath() + "ALPReqListForSCBySupplierNameAPI?searchByKey=" + elementValue +"&productos="+productos).load();
          }
        });
      });
