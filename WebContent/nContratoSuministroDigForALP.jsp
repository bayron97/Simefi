        ...
        <div class="container-fluid header-container">
          ...
          <!-- <div class="row submenu">
            <div class="container-fluid" id="submenu-container">
              <div class="row">
              <form action ="pcALPRouting" method="post">
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            ...
            <%
              ...
              try{ 
                ...
                String QueryString = "select noProcesoCompra,observaciones from procesoCompraALP WHERE cod="+id;
            ...
            <form id="digForm" method="post" action="digitizedDocumentALPServlet" enctype="multipart/form-data">
              ...
              >
                ...
                <button id="submit"
                  ...
                  if(funcion.contentEquals("modificar") || funcion.contentEquals("nuevo") || funcion.contentEquals("revisar")){
                	  %>
