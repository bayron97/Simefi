      ...
      <div class="content shadow-sm main-content-div">
		...
		%>
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	<form method="post" action="pRecepcionProductos">
          	<input type="hidden" id="id" name="id"/>
          	<input type="hidden" id="type" name="type" value="ALP"/>
         	<input type="hidden" id="type" name="next" value="recepcionProductos.jsp"/>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">MONTO TOTAL A PAGAR</th>
