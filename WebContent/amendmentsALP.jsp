          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
            ...
            <div class="card-body main-font">
              ...
              <table
                ...
                aria-describedby="Tabla de Aclaraciones y Enmiendas para ALP"
              >
                <thead>
                  <tr>
                    <th class="all">COD</th>
                    <th class="all">NO. PROCESO DE COMPRA</th>
                    <th class="min-desktop">FECHA TIPO DE DOCUMENTO</th>
                ...
                <tbody>
						        ...
						        try{
							      ...
							      String QueryString = "select cod, procesoCompra, fecha, tipo, correlativoDocumento, observaciones from dbo.aclaracionEnmiendaALP";
