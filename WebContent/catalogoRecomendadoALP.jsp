                    ...
                    >
                      ...
                      >
                        <thead>
                          <tr>
                            <th class="all">NO.</th>
                            <th class="min-desktop">NO. OFERTA DEL PROVEEDOR</th>
                            ...
                            <th class="min-desktop">CERTIFICADO DE BUENAS PRACTICAS DE MANUFACTURA</th>
                            <th class="min-desktop">NO. CERTIFICADO DE BUENAS PRACTICAS DE MANUFACTURA</th>
                            <th class="min-desktop">FECHA DE VENCIMIENTO</th>
                            ...
                            <th class="min-desktop">RECOMENDACIONES BENEFICIARIO</th>    
                          </tr>
                        </thead>
                        <tbody>
                          <%
                          ...
                          %>
                            <tr>
							  <td><%=count%></td>
							  <td><%=oferta.getnoOfertaIngresada()%></td>
                              <td><%=oferta.getDistribuidor().toUpperCase()%></td>
                              <td><%=oferta.getIdItem()%></td>
                              <td><%=oferta.getCodATC().toUpperCase()%></td>
                              <td><%=oferta.getcodSesal().toUpperCase()%></td>
                              <td><%=oferta.getMedicamentoEstimado().toUpperCase()%></td>
                              <td><%=oferta.getMedicamentoOfertado().toUpperCase()%></td>
                              <td><%=oferta.getDescripcionTecnicaRequerida().toUpperCase()%></td>
                              <td><%=oferta.getDescripcionTecnica().toUpperCase()%></td>
                              <td><%=oferta.getUnidadPresentacionRequerida().toUpperCase()%></td>
                              <td><%=oferta.getUp().toUpperCase()%></td>
                              <td><%=oferta.getcantidadRequerida()%></td>
                              <td><%=oferta.getcanEstimadaOferta()%></td>                              
                              <td><%=oferta.getPrecio()%></td>
                              <td><%=oferta.getMoneda() + " "+oferta.getprecioTotal() %></td>
                              <td><%=oferta.getNombreFabricante().toUpperCase()%></td>
                              <td><%=oferta.getPaisOrigen().toUpperCase()%></td>
                              <td><%=oferta.getRegistroSanitario().toUpperCase()%></td>
                              <td><%=oferta.getNumSanitario().toUpperCase()%></td>
                              
                             
                              <%
                              String fechaVencSan = oferta.getFechaVencSan();
                              ...
                              <td><%=fechaVencSan%></td>
                               <%
                              String fechaEmisionSan = oferta.getFechaEmisionSan();
                              ...
                              <td><%=oferta.getCertificadoManufactura()%></td>
                              <td><%=oferta.getNumCertif().toUpperCase()%></td>
                              
                              <%
                              String fechaVencManufactura = oferta.getFechaVencManufactura();
                              ...
                              <td><%=fechaVencManufactura%></td>
                               <%
                              String fechaEmisionManufactura = oferta.getFechaEmisionManufactura();
                              ...
                              <td><%=oferta.getEtiquetadoPrimario().toUpperCase()%></td>
                              <td><%=oferta.getEtiquetadoSecundario().toUpperCase()%></td>
                              <td><%=oferta.getEtiquetadoTerciario().toUpperCase()%></td>
                              <td><%=oferta.getprelacionRALP()%></td>
                              <td><%=oferta.getCriterioRecomendacion().toUpperCase()%></td>
                              <td><%=oferta.getObservaciones().toUpperCase()%></td>
                              <td><%=oferta.getRecomendacionesBeneficiario().toUpperCase()%></td>
                             </tr>
                          <%} %>
                        </tbody>
                      </table>
