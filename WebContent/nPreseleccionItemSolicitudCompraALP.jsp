...
<%
  ...
  //ArrayList<listaRequerimientoSolicitudCompraALP> reqProductNames = (ArrayList<listaRequerimientoSolicitudCompraALP>) request.getAttribute("reqProductNames");
  ArrayList<productoSolicitudCompraALP> reqProductNames = (ArrayList<productoSolicitudCompraALP>) request.getAttribute("reqProductNames");
      ...
      <div class="content shadow-sm main-content-div">
              ...
              <div class="row">
                ...
                <form method="post" action="solicitudCompraALPStepRouting">
                  ...
                  <input
                    type="submit"
                    class="hide"
                    id="listaRequerimientoRoute"
                    name="submit"
                    value="listaRequerimiento"
                  />
                  <input
                    type="submit"
                    class="hide"
                    id="solicitudDisponibilidadRoute"
                    name="submit"
                    value="solicitudDisponibilidad"
                  />
                  <nav class="navbar col-12 main-font">
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <label
                          class="dropdown-item"
                          for="criteriosEvaluacionRoute"
                        >
                          CRITERIOS DE EVALUACION
                        </label>
                        <label
                          class="dropdown-item"
                          for="listaRequerimientoRoute"
                        >
                          LISTA DE REQUERIMIENTO
                        </label>
                        <a type="button" class="dropdown-item active" href="#"
                          >PRE SELECCION ITEM-PROVEEDOR</a
                        >
                        <label
                          class="dropdown-item"
                          for="solicitudDisponibilidadRoute"
                        >
                    ...
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      <li class="nav-item">
                        <label class="nav-link" for="datosGeneralesRoute"
                          >DATOS GENERALES</label
                        >
                      </li>                      
                      <li class="nav-item">
                        <label class="nav-link" for="listaRequerimientoRoute"
                          >LISTA DE REQUERIMIENTO</label
                        >
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <label
                          class="nav-link"
                          for="solicitudDisponibilidadRoute"
                          >SOLICITUD DE DISPONIBILIDAD</label
                        >
                      </li>
                       <%}%>
                    </ul>
        ...
        <div class="container main-container" id="main-container">
          ...
          <div class="main-content-div main-font">
            <form id="newEditRegForm" action="preSeleccionIPSolicitudCompraALPServlet" method="post">
              <input type="hidden" name="id" value="${cod}" />
              <div class="row mt-4">
                <div class="col-lg-12 col-md-12">
                  <div class="row">
                    <div class="col-lg-12 col-md-12">
                      <h5>PRE SELECCION ITEM-PROVEEDOR</h5>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4 col-md-4">
                      <label>SELECCIONAR NO. ITEM</label>
                      <select
                        autocomplete="off"
                        class="form-control"
                        id="item"
                      ...
                      >
                        ...
                        <%
                          for(productoSolicitudCompraALP requerimiento : reqProductNames){
                        %>
                          <option value="<%=requerimiento.getnombreProductoSegunCatalogo().toUpperCase()%>">
                            <%=requerimiento.getnombreProductoSegunCatalogo().toUpperCase()%>
                          </option>
                        <%
                          }
                        %>
                  ...
                  <div class="row mt-3 mb-4">
                    <div class="col-lg-12 col-md-12" style="overflow-x: auto">
                      ...
                      >
                        <thead>
                          <tr>
                          <!-- <th class="min-desktop hide" >PROVEEDOR</th> -->
                            <th class="min-desktop">NO. OFICIO</th>
                           ...
                           <!--  <th class="min-tablet hide">
                              FABRICANTE / PAIS DE ORIGEN
                            </th>
                            <th class="min-desktop hide">
                            ...
                            <th class="min-tablet hide">PRECIO UNITARIO ACORDADO</th>
                            <th class="min-tablet hide">MONEDA</th> -->
                            
                            
                            
                            <!-- <th class="min-desktop hide">FECHA OFERTA</th>
                            <th class="min-tablet hide">NO. DE SOLICITUD DE DISPONIBILIDAD ASIGNADO</th> -->
                            <th class="all ">SELECTOR</th>
                          </tr>
                        </thead>
                        <tbody>
                        </tbody>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        $("#item").on("change", function (){
          ...
          reqTable.ajax.url(getAbsolutePath() + "ALPReqListForSCByKeySearchAPI?searchByKey=" + elementValue).load();
        });

        $("#seeAllCheck").on("change", function () {
          if($(this).prop("checked")){
            $("#item").prop("value", "NINGUNO")
            $("#item").prop("disabled", true)
            reqTable.ajax.url(getAbsolutePath() + "ALPReqListForSCByKeySearchAPI?searchByKey=all").load();
          }
          else{
      ...
      $("#submitButtonValidate").click(function(){    
    	  ...
    	  var checkedRows = $("#reqTable input[type=checkbox]:checked").parents("tr").clone();
  		 ...
  		 /*  if(checkedRows.length == 0){
  			alert("PORFAVOR SELECCIONE UN ITEM COMO MINIMO")
  			  return false;
  		  } */
         ...
         checkedRows.each(function () {
       	  ...
       	  var inputBC = document.createElement("input");
		        ...
		        inputBC.setAttribute("name","nomProductoFilter");
		      	inputBC.setAttribute("value", $(this).find( "td:eq(4)" ).html());
        ...
        document.getElementById("submitButton").value = document.getElementById("submitButtonValidate").value;
