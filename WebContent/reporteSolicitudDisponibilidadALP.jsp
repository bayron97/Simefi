      ...
      <div class="container-fluid mt-3 mb-3 font-custom">
        ...
        <div class="row mt-3">
          <p>
            ...
            >
            de fecha XXXXXX, sus Enmiendas y/o Ampliación,
        ...
        <div class="row border">
          <div class="col-12">
            ...
            <p>
              ...
              detallar la Fecha de Vencimiento (Vida úštil) de los productos
            ...
            <p>
              ...
              <strong class="font-weight-bold">EL PROVEEDOR</strong> presentá su
              Oferta en base a realizar entregas en el Municipio del Distrito
              Central (M.D.C.) en Francisco Morazán, sin embargo, como lo
              establecido en los Términos de Referencia (TDRâ€™s) y el Acuerdo a
