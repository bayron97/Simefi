  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <input class="hide" type="submit" id="enTimeRouteButton" name="submit" value="paramEnTime"/>
                    ...
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="#">BENEFICIARIO FINAL</a>
                        <label class="dropdown-item" for="enTimeRouteButton">TIEMPOS DE ENTREGA</label>
                        <label class="dropdown-item" for="purchaseTypeRouteButton">TIPOS DE COMPRA</label>
                        <label class="dropdown-item" for="ALPRouteButton">DESCRIPCION DE LA COMPRA</label>
                      </div>
                    </div>
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#">BENEFICIARIO FINAL</a>
                      </li>
                      <li class="nav-item">
                        <label class="nav-link" for="enTimeRouteButton">TIEMPOS DE ENTREGA</label>
                      </li>
                      <li class="nav-item">
                        <label class="nav-link" for="purchaseTypeRouteButton">TIPOS DE COMPRA</label>
                      </li>
                      <li class="nav-item">
                        <label class="nav-link" for="ALPRouteButton">DESCRIPCION DE LA COMPRA</label>
                      </li>
                    </ul>
                  </form>
                </nav>
            ...
            <div class="card-header border-0 bg-none">
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  ...
                  <button class="btn btn-sm btn-success ml-2">
                    <i class="material-icons md-18">arrow_back</i> CANCELAR
                  </button>
                </div>
              </div>
            </div>
            <div class="card-body main-font">
              ...
              >
                <thead>
                  <tr>
                    <th class="all">#</th>
                    <th class="min-tablet">BENEFICIARIO FINAL</th>
                    <th class="min-tablet">DIRECCION DE ENTREGA</th>
                ...
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.beneficiarioFinal";
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-left">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="backwardBeneficiarioFinal">
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-right">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="forwardBeneficiarioFinal">
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="beneficiarioFinalServlet">
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#benFinal").prop("value", value);
        value = $(this).find("td:eq(2)").text();
        $("#dirEntrega").prop("value", value);
