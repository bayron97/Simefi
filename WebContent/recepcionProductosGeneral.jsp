      ...
      <div class="content shadow-sm main-content-div">
        ...
        <div class="container main-container" id="main-container">
          ...
          <div class="card border-0 shadow-sm mb-4 main-content-div">
          	<form method="post" action="Gral_recepcionProductoServlet">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">VALOR CONTRATADO</th>
                    <th class="min-tablet">VALOR ENTREGADO</th>
	                <th class="min-tablet">VALOR CONTRATO CANCELADOS</th>
	                <th class="min-tablet">VALOR PENDIENTE ENTREGA</th>
	                <th class="min-tablet">PORCENTAJE PENDIENTE ENTREGA</th>
                ...
                <%
			        try{
				        ...
				        //String QueryString = "SELECT idAperturaProceso ,beneficiario ,numProcesoCompra ,SUM(valorContratado) ,SUM(valorEntregado), SUM(valorCancelado) ,SUM(valorPendienteEntrega), SUM(porcentajePendienteEntrega) FROM Gral.View_controlEntrega GROUP BY idAperturaProceso ,beneficiario,numProcesoCompra";
				       String QueryString = "SELECT idAperturaProceso ,beneficiario ,numProcesoCompra, (CAST(SUM(valorContratado) AS DECIMAL(20, 4))) as valorContratado, (CAST(SUM(valorEntregado) AS DECIMAL(20, 4))) as valorEntregado, (CAST(SUM(valorCancelado) AS DECIMAL(20, 4))) as valorCancelado ,(CAST(SUM(valorPendienteEntrega) AS DECIMAL(20, 4))) as valorPendienteEntrega, (CAST(SUM(porcentajePendienteEntrega) AS DECIMAL(20, 4))) as porcentajePendienteEntrega, monedaCompra FROM Gral.View_controlEntrega GROUP BY idAperturaProceso ,beneficiario,numProcesoCompra, monedaCompra";
				        rs = state.executeQuery(QueryString);
			  			int count = 1;
			        while(rs.next()){
			        	String moneda = "USD";
			        	
			        	if(rs.getString(9).contentEquals("LEMPIRAS (LPS.)")){
			        		moneda = "L";	
			        	}
			      ...
			      %>
						        <tr>
							        ...
							        <td><%=moneda + " " + rs.getString(4)%></td>
							        <td><%=moneda + " " + rs.getString(5)%></td>
							        <td><%=moneda + " " + rs.getString(6)%></td>
							        <td><%=moneda + " " + rs.getString(7)%></td>
							        <td><%=moneda + " " + rs.getString(8)%></td>
							         <td><%if(rs.getFloat(8) == 0){%>
							         CERRADA
							        	 <%}else{%>
							        		 VIGENTE
							        	 <%}%></td>
