                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-6">
                    ...
                    <h5 class="font-weight-light main-font">
                      PARAMETRIZACION / ACCESOS / MODULOS
                    </h5>
                  </div>
                </div>
              </div>
            ...
            <div class="card-header border-0 bg-none">
              <div class="row">
                ...
                switch(acceso){
                  case "administrar":
                %>
                <form action="revisarAcceso" method="post">
                  <input autocomplete="off" type="hidden" name="usuarioRevisar" id="usuarioRev">
                  <button
                    ...
                    value="modif"
                  >
                    <i class="material-icons md-18">playlist_add_check</i> PERMISOS
                  </button>
                  <button
                    class="btn btn-sm btn-success ml-2"
                    id="consultButton"
                    ...
                    value="consultar"
                  >
                    <i class="material-icons md-18">chrome_reader_mode</i> CONSULTAR
                  </button>
                  <button
                    class="btn btn-sm btn-success ml-2"
                    id="revAprovButton"
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">FUNCION</th>
                ...
                <tbody>
                  <%
						        try{
							      ...
							      String QueryString = "SELECT u.codigoEmpleado, u.usuario, u.nombre, u.puesto, u.funcion, a.estado1, a.estado2 FROM USUARIO U JOIN ACCESOS A ON U.USUARIO = A.Usuario group by u.codigoEmpleado, u.usuario, u.nombre, u.puesto, u.funcion, a.estado1, a.estado2";
						      ...
						      <tr>
							      ...
							      <%
                      if(
                      st6.toUpperCase().contentEquals("PENDIENTE APROBAR")){
                    %>
                    <td>
                      <div class="btn-warning btn btn-sm">PENDIENTE DE APROBAR</div>
                    </td>
                    <%}  
                      if( st6.toUpperCase().contentEquals("APROBADO")){
                    %>
                    <td>
                      <div class="btn-success btn btn-sm">APROBADO</div>
                    </td>
                    <%} 
                      if(st6.toUpperCase().contentEquals("RECHAZADO")){
                    %>
                    <td>
