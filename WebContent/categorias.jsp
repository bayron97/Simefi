...
<!-- Sidebar ends -->
					...
					<div class="container-fluid" id="submenu-container">
						<div class="row">
							...
							<form method="post" action="ParametrizacionRouting">
								...
								<input class="hide" type="submit" id="unidadpre" name="submit"
									value="up.jsp" />
								<div class="dropdown mr-auto d-flex d-sm-none">
									...
									<div class="dropdown-menu">
										<label class="dropdown-item" for="parametrizacion">VIA
											...
											for="nivelatencion">NIVEL DE ATENCION</label> <label
											class="dropdown-item" for="unidadpre">UNIDAD DE
											PRESENTACION (UP)</label> <a class="dropdown-item active" href="#">CATEGORIAS</a>
									</div>
								</div>
								<ul class="nav nav-pills mr-auto d-none d-sm-flex">
									...
									<li class="nav-item"><label class="nav-link"
										for="unidadpre">UNIDAD DE PRESENTACION (UP)</label></li>
									<li class="nav-item"><a class="nav-link active" href="#">CATEGORIAS</a>
									</li>
								</ul>
							</form>
							</nav>
						...
						<div class="container main-container">
							<div class="row align-items-center">
								<div class="col-12 col-xs-12 col-md-12">
									...
									<h5 class="font-weight-light main-font">CATEGORIAS</h5>
								</div>
							</div>
						</div>
					</div>
						...
						<table id="datatable"
							...
							<tbody>
								...
								try {
									...
									String QueryString = "SELECT * from dbo.categorias order by id ASC";
	...
	<div class="modal fade main-font" id="newEditReg" tabindex="-1"
		...
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<form id="editRegForm" method="post" action="categoriasServlet">
				<div class="modal-content shadow-lg-dark overflow-hidden">
					...
					<div class="modal-body" style="background-color: #f1f1f1;">
						...
						<div class="text-center pb-5">
							<h1 class="mb-0 text-white">PARAMETRIZACION DE CATEGORIAS
								PARA OTROS INSUMOS</h1>
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>CATEGORIA*</label> <input autocomplete="off"
																				type="text" class="form-control" id="overlayCat"
																				name="overlayCat" placeholder="" required />
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-12 col-md-12">
																		<div class="form-group">
																			<label>DESCRIPCION*</label> <input autocomplete="off"
																				type="text" class="form-control" id="overlayDesc"
																				name="overlayDesc" placeholder="" required />
																		</div>
																	</div>
																</div>
																<div class="row">
	...
	<script>
		...
		$("#datatable tr").click(
				function() {
					...
					$("#overlayCat").prop("value", value);
					value = $(this).find("td:eq(3)").text();
					$("#overlayDesc").prop("value", value);
				...
				.on(
						...
						function(event) {
							...
							var url = getAbsolutePath()
									+ "ValidarParamCategoriasAPI";
							var overlayCat = document
									.getElementById("overlayCat").value;
									...
									.ajax({
										...
										success : function(data) {
											...
											if (parseInt(data) == 0) {
												...
												$("#confirMessage")
														.text(
																"ALERTA! ESTA CATEGORIA YA ESTA REGISTRADA INGRESE UNA NUEVA");
