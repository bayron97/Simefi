  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
              ...
              <div class="row">
                ...
                <nav class="navbar col-12 main-font">
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <input class="hide" type="submit" id="benFinalRouteButton" name="submit" value="paramBenFinal"/>
                    ...
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <label class="dropdown-item" for="benFinalRouteButton">BENEFICIARIO FINAL</label>
                        <a class="dropdown-item active" href="#">TIEMPOS DE ENTREGA</a>
                    ...
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      ...
                      <li class="nav-item">
                        <label class="nav-link" for="benFinalRouteButton">BENEFICIARIO FINAL</label>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="#">TIEMPOS DE ENTREGA</a>
                      </li>
                      <li class="nav-item">
            ...
            <div class="card-body main-font">
              ...
              >
                <thead>
                  <tr>
                    <th class="all">#</th>
                    <th class="min-tablet">TIEMPO DE ENTREGA</th>
                ...
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.tiempoEntrega";
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-left">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="backwardEnTime">
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-right">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="forwardEnTime">
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form action="tiempoEntregaServlet" id="editRegForm" method="post" >
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#timEnt").prop("value", value);
        value = $(this).find("td:eq(3)").text();
        $("#obs").prop("value", value);
        value = $(this).find("td:eq(2) div").text();
