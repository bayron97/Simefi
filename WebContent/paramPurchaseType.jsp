  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
                  ...
                  <form method="post" action="pCompraParamRouting">
                    ...
                    <div class="dropdown mr-auto d-flex d-sm-none">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="#">MECANISMOS DE COMPRA</a>
                        <label class="dropdown-item" for="ALPRouteButton">TIPO DE COMPRA</label>
                        <label class="dropdown-item" for="Fabricante">DESCRIPCION DE LA COMPRA</label>
                    ...
                    <ul class="nav nav-pills mr-auto d-none d-sm-flex">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#">MECANISMOS DE COMPRA</a>
                      </li>
                      <li class="nav-item">
                ...
                <div class="col-auto align-self-center main-font">
                 <% if (acceso.contentEquals("administrar")){
                  ...
                  <!--button class="btn btn-sm btn-success ml-2">
                    <i class="material-icons md-18">done</i> APLICAR
                  </button-->
                   <% if (acceso.contentEquals("administrar")){
                	%>
                  <button
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-tablet">ABREVIATURA</th>
                    <th class="min-desktop">OBSERVACIONES</th>
                    <th class="min-tablet">ESTADO</th>
                    <th class="min-tablet">MOTIO</th>
                  </tr>
                </thead>
                <tbody>
                	<%
						try{
							...
							String QueryString = "SELECT * from dbo.tipoCompra";
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-left">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="paramOpeningPlace">
    ...
    <form method="post" action="pCompraParamRouting">
    	<div class="wrap-fixed-float wrap-fixed-bottom-right">
      		<button class="btn btn-primary btn-rounded-circle shadow" name="submit" value="paramALP">
    ...
    >
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="tipoCompraServlet">
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#purchaseType").prop("value", value);
        value = $(this).find("td:eq(3)").text();
        $("#abrev").prop("value", value);
      ...
      $('input[name=abrev]').bind('keypress', function(event) {
