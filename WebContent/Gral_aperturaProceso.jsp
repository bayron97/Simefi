                                ...
                                <div id="dataSection">                                  
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                      <div class="form-group">                                   
                                        <input autocomplete="off" type="time" class="form-control" id="horaLimiteView" name="horaLimiteView" placeholder="" value="${horaLimiteView}" required <%=read%>/>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                      <div class="form-group">
                                        <input autocomplete="off" type="date" class="form-control" id="fechaLimiteView" name="fechaLimiteView" placeholder="" value="${fechaLimiteView}" required  <%=read%>/>
                                      </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                      <div class="form-group">
                                        <input autocomplete="off" type="date" class="form-control" id="fechaAperturaView" name="fechaAperturaView"  placeholder="" value="${fechaAperturaView}" required <%=read%>/>
                                      </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                      <div class="form-group">
                                        <input autocomplete="off" type="time" class="form-control" id="horaAperturaView" name="horaAperturaView" placeholder="" value="${horaAperturaView}" required <%=read%>/>
                                      </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                      <div class="form-group" style="text-align: left;">
                                        ...
                                        <button hidden type = "button" class="btn btn-sm btn-success ml-3" id="deletRegButton"<%=disable%>>
                                   ...
                                   <div class="col-lg-2 col-md-2">
                                    ...
                                    <div class="col-lg-7 col-md-7">
                                      ...
                                      if(accion != null){  
                                    	  ...
                                    	  if(!accion.contentEquals("nuevo")){
                                    		  int idBeneficiario = (int)request.getAttribute("idBeneficiario");
                                        	  String beneficiario = (String)request.getAttribute("beneficiario");
                                    	  %>
                                    	 <input  type="hidden"  class="form-control" id="idBeneficiario" name="idBeneficiario" placeholder=""  value="<%=idBeneficiario%>" required <%=read%>/>
                                    	 <input  type="text" readonly="readonly" class="form-control" id="beneficiario" name="beneficiario" placeholder=""  value="<%=beneficiario%>" required <%=read%>/>
                                    	  <% }else{%>
                                              ...
                                              <input  type="hidden" class="form-control" id="beneficiario" name="beneficiario" placeholder=""  value="" required <%=read%>/>
                                              <%
                                              }                                    	  
                                      }
                                      %>
                                      ...
                                      <div class="form-group">
                       				...
                       				<%
                                       if(accion != null){                                          
                                     	ArrayList<Gral_oficioBeneficiario> oficiosList = (ArrayList<Gral_oficioBeneficiario>) request.getAttribute("oficios");
                                        if (oficiosList != null)
                                            {
                                        	 if(!accion.contentEquals("nuevo")){
                                              for(Gral_oficioBeneficiario oficio : oficiosList){
                                            	  ...
                                            	  <tr>
                                                    ...
                                                    <td><a href="assets/files/buyProcessGeneralFiles/legalDocumentForBeneficiary/<%=oficio.getnombreArchivo()%>" target="_blank"><%=oficio.getnombreArchivo()%></td>
                                                    </tr>
                                            	  <%
                                              }}}}; 
                                           %>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        $("#submitParamBens").click(function(){       	
          ...
          var nomArchivoSave = oficio+"."+fomateoDocumento;
          ...
          if(oficio!="" && oficio!=null ){
        	  if(archivo=="HAYARCHIVO"){
                  ...
                  td3.appendChild (document.createTextNode(oficio))
                  var td4 = document.createElement("TD")
                  td4.appendChild(document.createTextNode(nomArchivoSave))
