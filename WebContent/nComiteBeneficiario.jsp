              ...
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  ...
                  <form action="escrituraServlet" method="post">
                    ...
                    >
                      <i class="material-icons md-18">edit</i> VER Y AGREGAR INTEGRANTES
                    </button>
                    <button
                      class="btn btn-sm btn-success ml-2"
                      data-target="#newReg"
                    ...
                    >
                      <i class="material-icons md-18">add_circle</i> NUEVO COMITE
                    </button>
                    <button
                      class="btn btn-sm btn-success ml-2"
                      data-target="#newReg"
                  ...
                  <form action="escrituraServlet" method="post">
                    ...
                    <button
                      ...
                      value="agregarAccionista"
                    >
                      <i class="material-icons md-18">edit</i> VER INTEGRANTES
                    </button>
                  </form>
                  <% } %>
                </div>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="all">DENOMINACION SOCIAL</th>
                    <th class="min-desktop">OFICIO</th>
                ...
                <tbody>
                    <%
						          try{
							          ...
							          String QueryString = "select nombre, matricula, tipoId, noId, fecha, padre, nacionalidad, paisResidencia, participacion, tipoAccionista, cantidadAcciones,telefono, estado1, estado2, num from dbo.escrituras where padre = '" +  padre + "'";
						        ...
						        <% 	
						            while(rs.next()){
							            ...
							            String st2 = rs.getString(5);
							            if(rs.wasNull()){
								            st2 = " ";
							            }
							            String ob = rs.getString(13);
							            if(rs.wasNull()){
								            ob = " ";
							            }
							            String obs = rs.getString(14);
							            if(rs.wasNull()){
								            obs = " ";
							            }
						          %>
    ...
    <form method="post" action="escrituraServlet" class="main-font">
      <input autocomplete="off" type="hidden" value="${padre}" name="padre">	
    	...
    	<div class="wrap-fixed-float wrap-fixed-bottom-right">
      		<button class="btn btn-primary btn-rounded shadow" name="submit" id="submit" value="ct">
            ...
            <div class="modal-body" style="background-color: #f1f1f1;">
              ...
              <div class="text-center pb-5">
                <h1 class="mb-0 text-white">
                  REGISTRO DE LISTADOS DE COMITES TECNICOS
                </h1>
                <h4
                  id="subtitleChange"
