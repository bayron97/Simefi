                ...
                <div class="row align-items-center">
                  <div class="col-12 col-xs-12 col-md-12">
                    <h2 class="mb-4 large-title">
                      RATIFICACION DE RECOMENDACIONES POR PROCESO DE COMPRA
                    </h2>
              ...
              <div class="row">
                ...
                <div class="col-auto align-self-center main-font">
                  ...
                  <button
                    ...
                    name="submit"
                    value="nuevaRatificacion"
                  >
                    <i class="material-icons md-18">done_all</i> INGRESAR RATIFICACIONES
                  </button>
                  <% } %>
                ...
                <tbody>	
					         <%
						        try{
							        ...
							        String QueryString = "SELECT cod, procesoCompra, fecha, productosConOfertas, observaciones, productosEstimados, productosCompletados from dbo.vaciadoOfertasALP where productosRecomendados >= 1";
