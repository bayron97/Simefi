...
<body class="sidemenu-open header-fixed-top body-general-styles">
	...
	<script>
		...
		$(document).ready(function() {
							...
							reqTable.ajax.url(getAbsolutePath() + "InformesDataALPAPI" + "?submit=infRecContratacionSegundaRCC&codSolicitudCompraParam="+codSolicitudCompraParam+"&procesoCompraParam="+procesoCompraParam).load();
