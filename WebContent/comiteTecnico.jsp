  ...
  <body class="sidemenu-open header-fixed-top body-general-styles">
   ...
   <jsp:include page="Menu.jsp" flush="true" />
                ...
                <div class="row align-items-center">
                  <div class="col-8 col-xs-8 col-md-8">
                    <h2 class="mb-4 large-title">
                      LISTADO DE INTEGRANTES POR COMITE
                    </h2>
                    <h5 class="font-weight-light main-font">
                      ADMINISTRACION DE DATOS / BENEFICIARIOS / COMITE TECNICO
                    </h5>
                  </div>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="min-desktop">TIPO DE INTEGRANTE</th>
                    <th class="min-desktop">NO. DE IDENTIFICACION</th>
                    <th class="min-desktop">CORREO 1</th>
                    <th class="none">CORREO 2</th>
                    <th class="min-desktop">CARGO</th>
                    <th hidden class="min-desktop">ID DB</th>
                  </tr>
                </thead>
                <tbody>
                  <%
						      ...
						      %>
						        <tr>
							        ...
							        <td><%=rs.getString(17).toUpperCase()%></td>
							        <td><%=rs.getString(6).toUpperCase()%></td>
							        <td><%=rs.getString(15).toUpperCase()%></td>
							        <td><%=rs.getString(16).toUpperCase()%></td>
							        <td><%=rs.getString(14).toUpperCase()%></td>
							        <td hidden><%=rs.getString(18)%></td>
						        </tr>
						      <%i = i + 1;} 
						          rs.close();
						          state.close();
    ...
    <form method="post" action="accionistaServlet" class="main-font">
      <input autocomplete="off" type="hidden" name="modifTipo" value="${modifTipo}">
			<input autocomplete="off" type="hidden" name="padre" id="padre" value="${padre}">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <form id="editRegForm" method="post" action="accionistaServlet">
          <div class="modal-content shadow-lg-dark overflow-hidden">
            ...
            <div class="modal-body" style="background-color: #f1f1f1;">
              ...
              <div class="text-center pb-5">
                <h1 class="mb-0 text-white">
                  REGISTRO DE INTEGRANTES POR COMITE
                </h1>
                <h4
                  id="subtitleChange"
                        ...
                        <div class="card-body">
                          <div class="row justify-content-center">
                            <div class="col-md-10 mx-auto">
                              <!--DATA Section-->
                              <div id="dataSection">
                               <input autocomplete="off" type="hidden" id="idAccionistaEscritura" name="idAccionistaEscritura"/>
                                <input autocomplete="off" type="hidden" id="idaprov" name="idaprov"/>
                                <input autocomplete="off" type="hidden" id="nombreEscritura" value="${nombreEscritura}" name="nombreEscritura"/>
                                <div class="row">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" id="tipoIntegrante" name="tipoIntegrante" required>
            ...
            <input autocomplete="off" type="hidden" value="${padre}" name="padre" id="padre">
					  <input autocomplete="off" type="hidden" value="${escrituraPadre}" name="escrituraPadre" id="escrituraPadre">
					  <input autocomplete="off" type="hidden" value="${oldId}" name="oldId" id="oldId">
					  <input autocomplete="off" type="hidden" name="modifTipo" value="${modifTipo}">
					  <input autocomplete="off" type="hidden" name="isRev" value="${isRev}">
					  <input autocomplete="off" type="hidden" name="oldP" id ="oldP">
					  <input autocomplete="off" type="hidden" name="isConsultar" value="${isConsultar}">
					  <input autocomplete="off" type="hidden" name="isModif" value="${isModif}">
    ...
    <script>
      ...
      $("#datatable tr").click(function () {
        ...
        $("#correo1").prop("value", value);
        value=$(this).find('td:eq(6)').text();
        $("#correo2").prop("value", value);
