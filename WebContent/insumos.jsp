...
<body class="sidemenu-open header-fixed-top body-general-styles">
						...
						<div class="container main-container">
							<div class="row align-items-center">
								<div class="col-12 col-xs-12 col-md-12">
									<h2 class="mb-4 large-title">OTROS</h2>
					...
					<div class="card-header border-0 bg-none">
						<div class="row">
							...
							<div class="col-auto align-self-center main-font">
								...
								%>
								<form action="otrosServlet" method="post">
									<input autocomplete="off" type="hidden" id="modifyId"
										name="modifyId" />
									...
									<button class="btn btn-sm btn-success ml-2" id="nuevoBtn"
										...
										onclick="event.preventDefault();window.location.href='nOtros.jsp';">
						...
						<table id="datatable"
							...
							<thead>
								...
								<th class="all">COD.</th>
									...
									<th class="none">OBSERVACIONES DE ARTICULO:</th>
							...
							<tbody>
								...
								try {
									...
									String QueryString = "SELECT * from dbo.otros";
								...
								<tr>
									...
									<%
									if (st5.toUpperCase().contentEquals("RECHAZADO")) {
									%>
									<td>
									...
									else if (st5.toUpperCase().contentEquals("PENDIENTE DE APROBAR")) {
									%>
									...
									<%
									} else if (st5.toUpperCase().contentEquals("APROBADO")) {
									%>
									...
									%>
									<%
									if (st7.toUpperCase() == null || st7.toUpperCase().isEmpty() || st7.toUpperCase().contentEquals("INACTIVO")) {
									%>
									<td>
										<div class="btn-secondary btn btn-sm">INACTIVO</div>
									</td>
									<%
									} else if (st7.toUpperCase().contentEquals("NO ACTIVO")) {
									%>
									<td>
										<div class="btn-danger btn btn-sm">INACTIVO</div>
									</td>
									<%
									} else {
									%>
	...
	<script>
		...
		$("#confirmamodificacion")
				.click(
						function() {
							var elemento = document.getElementById("modifyId").value;

							if (elemento == null || elemento == "") {
								$("#confirMessagealert")
										.text(
												"ALERTA! POR FAVOR SELECCIONE UN BENEFICIARIO PARA EDITAR");
								$("#alerta").modal('show');
							} else {
		...
		$("#newDistButton").click(
				function() {
					var url = getAbsolutePath() + "EstadoInsumoModificarAPI";
					var modifId = document.getElementById("modifyId").value;
					$.ajax({
						url : url,
						type : "POST",
						dataType : 'json',
